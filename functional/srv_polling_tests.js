...
const _topologyDescription = require('../../../lib/sdam/topology_description');
...
const SrvPoller = require('../../../lib/sdam/srv_polling').SrvPoller;
const SrvPollingEvent = require('../../../lib/sdam/srv_polling').SrvPollingEvent;
