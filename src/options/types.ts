...
export interface DriverOptions extends UriOptions {
  /** The maximum number of connections in the connection pool. */
  poolSize?: UriOptions['maxPoolSize'];
  ...
  /** Enable autoReconnect for single server instances */
  auto_reconnect?: DriverOptions['autoReconnect'];
  ...
  wtimeout?: UriOptions['wtimeoutMS'];
  /** Corresponds to the write concern j Option option. The journal option requests acknowledgement from MongoDB that the write operation has been written to the journal. */
  j?: UriOptions['journal'];
...
export interface ClientOptions extends UriOptions, DriverOptions {}
