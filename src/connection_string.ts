...
export function parseOptions(
  ...
  const internalLoggerConfigFlag = Symbol.for('@@mdb.internalLoggerConfig');
  const internalLoggerConfig = mongoOptions[internalLoggerConfigFlag] ?? {};
  ...
  return { ...mongoOptions, ...internalLoggerConfig };
}
