...
# On old versions of TS we need to put the node types back to 18.16.3
npm install --no-save --force typescript@"$TS_VERSION" "$(if [[ $TS_VERSION == '4.1.6' ]]; then echo "@types/node@18.16.3"; else echo ""; fi)"
