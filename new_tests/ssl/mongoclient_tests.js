...
exports.shouldCorrectlyCommunicateUsingSSLSocket = function(configuration, test) {
  ...
  // Start server
  serverManager = new ServerManager({auth:false, purgedirectories:true, journal:true, ssl:true, ssl_server_pem: "../new_tests/ssl/certificates/server.pem"})
...
exports.shouldCorrectlyValidateServerCertificate = function(configuration, test) {
  ...
  serverManager = new ServerManager({
    ...
    , journal:true
    , ssl:true
    , ssl_server_pem: "../new_tests/ssl/certificates/server.pem"
  });
...
exports.shouldCorrectlyValidatePresentedServerCertificateAndPresentValidCertificate = function(configuration, test) {
  ...
  serverManager = new ServerManager({
    ...
    , journal:true
    , ssl:true
    , ssl_ca: '../new_tests/ssl/certificates/ca.pem'
    , ssl_crl: '../new_tests/ssl/certificates/crl.pem'
    , ssl_server_pem: "../new_tests/ssl/certificates/server.pem"
