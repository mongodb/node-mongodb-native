...
//     [
//         '/new_tests/authentication/authentication_tests.js'
//     ]
//   );

// auth_single_server_runner.run('single_server_auth');
...
//     [
//         '/new_tests/authentication/authentication_replicaset_tests.js'
//     ]
//   );

// auth_replset_server_runner.run('replica_set_auth');
...
//     [
//         '/new_tests/authentication/authentication_sharded_tests.js'
//     ]
//   );

// auth_sharded_server_runner.run('sharded_auth');
...
var ssl_server_runner = Runner
  ...
  .add("ssl_tests",
    [
        '/new_tests/ssl/mongoclient_tests.js'
        , '/new_tests/ssl/ssl_validation_tests.js'
    ]
  );

ssl_server_runner.run('none');
