...
describe('Connection String', function () {
  ...
  describe('non-genuine hosts', () => {
    ...
    const test_cases = [
      ...
      ['non-SRV cosmosDB uri', 'mongodb://a.mongo.cosmos.azure.com.tld:19555/', cosmosDBmsg],
      ['non-SRV documentDB uri', 'mongodb://a.docdb.amazonaws.com.tld:27017/', docDBmsg],
      ['non-SRV documentDB uri 2', 'mongodb://a.docdb-elastic.amazonaws.com.tld:27017/', docDBmsg],
      ['SRV cosmosDB uri', 'mongodb+srv://a.mongo.cosmos.azure.com.tld/', cosmosDBmsg],
      ['SRV documentDB uri', 'mongodb+srv://a.docdb.amazonaws.com.tld/', docDBmsg],
      ['SRV documentDB uri 2', 'mongodb+srv://a.docdb-elastic.amazonaws.com.tld/', docDBmsg]
    ];
