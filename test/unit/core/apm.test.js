...
describe('APM tests', function () {
  describe('CommandStartedEvent', function () {
    ...
    it(
      'should wrap a basic query option',
    ...
    it(
      'should wrap a basic killCursor command',
      { metadata: { requires: { topology: ['single'] } } },
      function () {
        const db = 'test2';
    ...
    it(
      'should wrap a basic GetMore command',
      { metadata: { requires: { topology: ['single'] } } },
      function () {
        const db = 'test3';
    ...
    it(
      'should upconvert a Query wrapping a query into a find command',
      { metadata: { requires: { topology: ['single'] } } },
      function () {
        const db = 'test5';
