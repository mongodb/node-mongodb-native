...
maybeDescribe('Connections survive primary step down', function () {
  ...
  it('getMore iteration', {
    metadata: { requires: { mongodb: '>=4.2.0', topology: 'replicaset', auth: 'disabled' } },
  ...
  it('Not Primary - Reset Connection Pool', {
    metadata: { requires: { mongodb: '4.0.x', topology: 'replicaset', auth: 'disabled' } },
    test: function () {
  ...
  it('Shutdown in progress - Reset Connection Pool', {
    metadata: { requires: { mongodb: '>=4.0.0', topology: 'replicaset', auth: 'disabled' } },
    test: function () {
