...
describe('Write Concern', function () {
  describe('when the WriteConcern is set in the uri', function () {
    let client;
  ...
  describe('when performing read operations', function () {
    describe('when writeConcern = 0', function () {
      describe('cursor creating operations with a getMore', function () {
        ...
        it('succeeds on changeStream', { requires: { topology: 'replicaset' } }, async function () {
