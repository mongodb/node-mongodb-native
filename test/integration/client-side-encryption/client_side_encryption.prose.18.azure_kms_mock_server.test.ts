...
describe('Azure KMS Mock Server Tests', function () {
  describe('Case 1: Success', metadata, function () {
  ...
  describe('Case 2: Empty JSON', metadata, function () {
  ...
  describe('Case 3: Bad JSON', metadata, function () {
  ...
  describe('Case 4: HTTP 404', metadata, function () {
  ...
  describe('Case 5: HTTP 500', metadata, function () {
  ...
  describe('Case 6: Slow Response', metadata, function () {
