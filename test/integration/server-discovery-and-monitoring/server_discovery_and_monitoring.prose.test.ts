...
describe('Server Discovery and Monitoring Prose Tests', function () {
  describe('Monitors sleep at least minHeartbeatFrequencyMS between checks', function () {
    /*
    ...
    it(
      'ensure monitors sleep for an appropriate amount of time between pings',
      { requires: { mongodb: '>=4.9.0', topology: '!load-balanced' } },
      async function () {
        // 3.
