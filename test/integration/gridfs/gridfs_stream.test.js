...
describe('GridFS Stream', function () {
   ...
   */
  it('should upload from file stream', { requires: { topology: ['single'] } }, function (done) {
  ...
  it('destroy publishes provided error', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
   ...
   */
  it(
    'should upload from file stream with custom id',
   ...
   */
  it('should download to upload stream', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
   ...
   */
  it(
    'should fail to locate gridfs stream',
    { requires: { topology: ['single'] } },
    function (done) {
      const configuration = this.configuration;
      const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
   ...
   */
  it('openDownloadStreamByName', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
   ...
   */
  it(
    'start/end options for openDownloadStream',
    { requires: { topology: ['single'] } },
    function (done) {
      const configuration = this.configuration;
      const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
   ...
   */
  it('Deleting a file', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
  ...
  it(
    'writing to an aborted stream throws API error',
    { requires: { topology: ['single'] } },
    async function () {
   ...
   * @example-method drop
   */
  it('drop using promises', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
   ...
   * @example-method find
   */
  it('find example', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
   ...
   */
  it('rename example', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
  ...
  it('download empty doc', { requires: { topology: ['single'] } }, function (done) {
    const configuration = this.configuration;
    const client = configuration.newClient(configuration.writeConcernMax(), { maxPoolSize: 1 });
    client.connect(function (err, client) {
      const db = client.db(configuration.db);
  ...
  it('should use chunkSize for download', { requires: { topology: ['single'] } }, function (done) {
  ...
  it(
    'should return only end - start bytes when the end is within a chunk',
    { requires: { topology: ['single'] } },
    function (done) {
