...
describe('class MongoClient', function () {
  ...
  it(
    'Should fail due to wrong uri user:password@localhost',
    {
  ...
  it(
    'correctly error out when no socket available on MongoClient `connect`',
    {
      requires: { topology: ['single', 'replicaset', 'sharded'] }
    },
    function (done) {
  ...
  it(
    'Should correctly pass through appname',
    {
      requires: {
  ...
  it(
    'Should correctly pass through appname in options',
    {
      requires: {
        topology: ['single', 'replicaset', 'sharded']
      }
  ...
  it(
    'Should correctly pass through socketTimeoutMS and connectTimeoutMS',
    {
      requires: {
        topology: ['single', 'replicaset', 'sharded']
      }
  ...
  it(
    'should open a new MongoClient connection',
    {
      requires: {
        topology: ['single']
      }
  ...
  it(
    'should open a new MongoClient connection using promise',
    {
      requires: {
        topology: ['single']
      }
  ...
  it('should error on unexpected options', { requires: { topology: 'single' } }, function (done) {
    const configuration = this.configuration;
    MongoClient.connect(
      configuration.url(),
      {
  ...
  it(
    'should error on unexpected options (promise)',
    { requires: { topology: 'single' } },
    function () {
      const options = {
        maxPoolSize: 4,
  ...
  it(
    'must respect an infinite connectTimeoutMS for the streaming protocol',
  ...
  it(
    'must respect a finite connectTimeoutMS for the streaming protocol',
    { requires: { topology: 'replicaset', mongodb: '>= 4.4' } },
    async function () {
      client = this.configuration.newClient({
        connectTimeoutMS: 10,
