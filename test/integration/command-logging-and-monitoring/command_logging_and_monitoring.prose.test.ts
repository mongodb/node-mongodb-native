...
describe('Command Logging and Monitoring Prose Tests', function () {
  ...
  describe('When no custom truncation limit is provided', function () {
    /*
  ...
  describe('When custom truncation limit is provided', function () {
    /*
        1. Configure logging with a minimum severity level of "debug" for the "command" component.
  ...
  describe('Truncation with multi-byte codepoints', function () {
    /*
