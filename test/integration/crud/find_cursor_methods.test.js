...
describe('Find Cursor', function () {
  ...
  describe('#close', function () {
    ...
    describe('when closed before completely iterated', () => {
    ...
    describe('when closed after completely iterated', () => {
    ...
    describe('when closed before initialization', () => {
      it('does not send a killCursors command', async () => {
        const killCursorsCommands = [];
        client.on('commandStarted', filterForCommands(['killCursors'], killCursorsCommands));
        const cursor = collection.find();
  ...
  describe('#allowDiskUse', function () {
    ...
    it(
      'throws if the query does not have sort specified',
      { requires: { mongodb: '>=4.4' } },
      function (done) {
        const coll = client.db().collection('abstract_cursor');
        const cursor = coll.find({});
