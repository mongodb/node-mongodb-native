...
describe('Server Selection Sharded Retryable Writes Prose tests', function () {
  describe('Test that in a sharded cluster writes are retried on a different mongos if one available', function () {
  ...
  describe('Test that in a sharded cluster writes are retried on the same mongos if no other is available', function () {
