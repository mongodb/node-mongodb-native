...
export const flakyTests = [
  ...
  'CSOT spec tests legacy timeouts behave correctly for retryable operations operation fails after two consecutive socket timeouts - deleteOne on collection',
  ...
  'CSOT spec tests legacy timeouts behave correctly for retryable operations operation succeeds after one socket timeout - listDatabases on client',
