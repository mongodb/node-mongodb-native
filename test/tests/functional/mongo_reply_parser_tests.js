 ...
 * @ignore
 */
exports['Should correctly parse perfectly aligned message from socket'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse perfectly aligned double message from socket'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse message + in two packets from socket'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse message + in two packets from socket and partial third one'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one then rest of the message'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one then partial message'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one then partial message into a bigger buffer'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Corrupt the message baby'] = {
  metadata: {},
 ...
 * @ignore
 */
exports['Corrupt the message baby but catch the log error'] = {
  metadata: {},
