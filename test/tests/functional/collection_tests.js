...
exports.shouldCorrectlyRetriveCollectionNames = {
  ...
  // The actual test we wish to run
  test: function(configuration, test) {
    configuration.newDbInstance({w:0}, {poolSize:1}).open(function(err, db) {
 ...
 * @ignore
 */
exports.shouldThrowErrorOnAttemptingSafeRemoveWithNoCallback = {
  metadata: {},
 ...
 * @ignore
 */
exports.shouldThrowErrorOnAttemptingSafeInsertWithNoCallback = {
  metadata: {},
 ...
 * @ignore
 */
exports.shouldThrowErrorOnAttemptingSafeUpdateWithNoCallback = {
  metadata: {},
