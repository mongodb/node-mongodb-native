...
// -----------------------------------------------------------------------------
suite.addTest(
  new Benchmark('LDJSON multi-file import', {
    iterations: 1,
    cycles: 1
  })
...
// -----------------------------------------------------------------------------
suite.addTest(
  new Benchmark('LDJSON multi-file export', {
    iterations: 1,
    cycles: 1
  })
    // Add custom method (we are responsible for marking the demarkation)
...
// -----------------------------------------------------------------------------
suite.addTest(
  new Benchmark('GridFS multi-file upload', {
    iterations: 1,
    cycles: 1
  })
    // Add custom method (we are responsible for marking the demarkation)
...
// -----------------------------------------------------------------------------
suite.addTest(
  new Benchmark('GridFS multi-file download', {
    iterations: 1,
    cycles: 1
  })
    // Add custom method (we are responsible for marking the demarkation)
