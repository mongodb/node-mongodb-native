...
suite.addTest(
  new Benchmark('flat json serialization')
    ...
    .setup(function(context, options, callback) {
      ...
      var json = fs.readFileSync(
        f('%s/performance-data/EXTENDED_JSON/flat_bson.json', __dirname),
        'utf8'
      );
...
suite.addTest(
  new Benchmark('flat json deserialization')
    // Add custom method (we are responsible for marking the demarkation)
    .custom(function(context, stats, callback) {
      // Create a bson serializer
      var bson = new BSON([
...
// Add the flat json parsing test
suite.addTest(
  new Benchmark('common nested json serialization')
    // Add custom method (we are responsible for marking the demarkation)
    .custom(function(context, stats, callback) {
      // Create a bson serializer
      var bson = new BSON([
    ...
    .setup(function(context, options, callback) {
      ...
      // Get the json document
      var json = fs.readFileSync(
        f('%s/performance-data/EXTENDED_JSON/deep_bson.json', __dirname),
        'utf8'
      );
      json = JSON.parse(json);
      json = deflate(json);
...
suite.addTest(
  new Benchmark('common nested json deserialization')
    // Add custom method (we are responsible for marking the demarkation)
    .custom(function(context, stats, callback) {
      // Create a bson serializer
      var bson = new BSON([
...
// Add the flat json parsing test
suite.addTest(
  new Benchmark('all json types serialization')
    // Add custom method (we are responsible for marking the demarkation)
    .custom(function(context, stats, callback) {
      // Create a bson serializer
      var bson = new BSON([
    ...
    .setup(function(context, options, callback) {
      ...
      // Get the json document
      var json = fs.readFileSync(
        f('%s/performance-data/EXTENDED_JSON/full_bson.json', __dirname),
        'utf8'
      );
      json = JSON.parse(json);
      json = deflate(json);
...
suite.addTest(
  new Benchmark('all json types deserialization')
    // Add custom method (we are responsible for marking the demarkation)
    .custom(function(context, stats, callback) {
      // Create a bson serializer
      var bson = new BSON([
