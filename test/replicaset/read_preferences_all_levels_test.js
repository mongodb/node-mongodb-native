...
exports['Set read preference at db level'] = function(test) {
  ...
  // Create db instance
  var db = new Db('integration_test_', replSet, {safe:false, native_parser: (process.env['TEST_NATIVE'] != null), readPreference:new ReadPreference(ReadPreference.SECONDARY)});
  // Connect to the db
  db.open(function(err, p_db) {
