...
exports['Should correctly parse perfectly aligned message from socket'] = function(test) {    
  // Data object
  var index = 0;
...
exports['Should correctly parse perfectly aligned double message from socket'] = function(test) {    
  // Data object
  var index = 0;
...
exports['Should correctly parse message + in two packets from socket'] = function(test) {    
  // Data object
  var index = 0;
  var buffer = new Buffer(10);
  var value = 10;
...
exports['Should correctly parse message + in two packets from socket and partial third one'] = function(test) {    
  // Data object
  var index = 0;
  var buffer = new Buffer(20);
  var value = 10;
...
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one'] = function(test) {    
  // Data object
  var index = 0;
  var buffer = new Buffer(20);
  var value = 10;
...
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one then rest of the message'] = function(test) {    
  // Data object
  var index = 0;
  var buffer = new Buffer(20);
  var value = 10;
...
exports['Should correctly parse message + in two packets from socket and smaller than 4 bytes additional one then partial message'] = function(test) {    
  // Data object
  var index = 0;
  var buffer = new Buffer(20);
  var value = 10;
...
exports['Corrupt the message baby'] = function(test) {
  // Data object
  var index = 0;
  var buffer = new Buffer(40);
  var value = -40;
...
exports['Corrupt the message baby but catch the log error'] = function(test) {
  // Data object
  var index = 0;
  var buffer = new Buffer(40);
