...
var tests = testCase({
  ...
  "Serialize learnBoost document and verify correct deserialization" : function(test) {
    var doc = learnBoostDoc1;
    var serialized_data = BSONSE.BSON.serialize(doc, false, true);  
    var serialized_data2 = new Buffer(BSONSE.BSON.calculateObjectSize(doc));
    BSONSE.BSON.serializeWithBufferAndIndex(doc, false, serialized_data2, 0);    
    assertBuffersEqual(test, serialized_data, serialized_data2, 0);  
...
// Crazy docs
var learnBoostDoc1 = {
	"_id" : new ObjectID("4e6f6ea583e3f9d525028f40"),
	"account" : {
	...
	"classprofiles" : [ ],
	"classrooms" : [
		new ObjectID("4e6f700383e3f9d525029771"),
		new ObjectID("4e6f7c8316793cd72503e1fa"),
		new ObjectID("4e6f97ce83e3f9d525040a07")
	],
	"contact" : {
		"email" : "aramje@aol.com"
	},
	"facebookSignup" : true,
	"has_avatar" : {
		"small" : "https://graph.facebook.com/176204684/picture?type=square",
		"large" : "https://graph.facebook.com/176204684/picture?type=large"
	},
	"information" : {
		"files" : [ ]
	},
	"lastScheduleViewed" : "A",
	"location" : {
	...
	"notes" : [ ],
	"oauth" : {
		"facebook" : "152590394799591|736c2a2473dd4e7257d97421.1-176204684|iNtG-tx2ooDYU1nMZi70uGz7iKo"
	},
	"periods" : [
		{
			"twelve_timestart" : "07:00 AM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c33"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "08:00 AM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c35"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "09:00 AM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c37"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "10:00 AM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c39"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "11:00 AM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c3b"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "12:00 PM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c3d"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "01:00 PM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c3f"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "02:00 PM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c41"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "03:00 PM",
			"name" : "",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c43"),
			"after-school" : false,
			"lunch" : false
		},
		{
			"twelve_timestart" : "04:00 PM",
			"name" : "After",
			"_id" : new ObjectID("4e6f705a83e3f9d525029c45"),
			"after-school" : true,
			"lunch" : false
		}
	],
