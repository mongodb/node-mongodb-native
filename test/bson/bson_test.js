...
var BSONSE = mongodb.BSON,
  BSONDE = mongodb.BSON;
  
BSONDE = require('../../lib/mongodb').native().BSON;
...
var tests = testCase({
  ...
  //   }
  //   var object = BSONDE.deserialize(new Buffer(serialized_data, 'binary'), false, true);
  ...
  //   var serialized_data = BSONSE.serialize(test_string, false, true);
  //   test.deepEqual(test_string, BSONDE.deserialize(serialized_data));
  //   test.done();
  // },
  // 
  // 'Should Correctly Serialize and Deserialize Integer' : function(test) {    
  //   var test_number = {doc: 5};
  //   var serialized_data = BSONSE.serialize(test_number, false, true);
  //   test.deepEqual(test_number, BSONDE.deserialize(serialized_data));
  //   test.done();
  // },
  // 
  // 'Should Correctly Serialize and Deserialize null value' : function(test) {
  //   var test_null = {doc:null};
  //   var serialized_data = BSONSE.serialize(test_null);
  //       
  //   var object = BSONDE.deserialize(serialized_data);
  ...
  // 'Should Correctly Serialize and Deserialize Integer' : function(test) {
  //   var test_int = {doc: 42};
  //   var serialized_data = BSONSE.serialize(test_int, false, true);
  //   test.deepEqual(test_int.doc, BSONDE.deserialize(serialized_data).doc);
  // 
  //   test_int = {doc: -5600};
  //   serialized_data = BSONSE.serialize(test_int, false, true);
  //   test.deepEqual(test_int.doc, BSONDE.deserialize(serialized_data).doc);
  // 
  ...
  // 
  //   test.deepEqual(doc.doc.age, BSONDE.deserialize(serialized_data).doc.age);
  //   test.deepEqual(doc.doc.name, BSONDE.deserialize(serialized_data).doc.name);
  //   test.deepEqual(doc.doc.shoe_size, BSONDE.deserialize(serialized_data).doc.shoe_size);
  //   test.done();        
  // },
  // 
  ...
  //   var doc = {doc: [1, 2, 'a', 'b']};
  //   var serialized_data = BSONSE.serialize(doc, false, true);
  //   var deserialized = BSONDE.deserialize(serialized_data);
  ...
  //   var doc = {doc: {doc:1}};
  //   var serialized_data = BSONSE.serialize(doc, false, true);
  //   test.deepEqual(doc, BSONDE.deserialize(serialized_data));
  //   test.done();            
  // },
  // 
  ...
  //   var serialized_data = BSONSE.serialize(doc, false, true);
  // 
  //   test.deepEqual(doc.date, BSONDE.deserialize(serialized_data).date);
  //   test.done();        
  // },
  //     
  ...
  //   var serialized_data = BSONSE.serialize(doc, false, true);
  //   var decoded_hash = BSONDE.deserialize(serialized_data).doc;
  //   var keys = [];
  // 
  ...
  //   serialized_data = BSONSE.serialize(doc, false, true);
  //   deserialized_data = BSONDE.deserialize(serialized_data);
  //   test.deepEqual(doc.doc, deserialized_data.doc);
  //   
  ...
  //   var serialized_data = BSONSE.serialize(hash, false, true);
  //   var deserialized_data = BSONDE.deserialize(serialized_data);
  //   var keys = [];
  // 
  ...
  //   //   debug("[" + i + "] :: " + serialized_data.toString('ascii', i, i+1) + " :: [" + serialized_data[i] + "]")      
  ...
  //   
  //   // debug("==================================================")
  //   // debug(inspect(deserialized_data))
  //   // debug(inspect(deserialized_data.doc.doc2.scope))
  //   
