...
var tests = testCase({
  ...
  shouldCorrectlyLogContent : function(test) {
    ...
    var automatic_connect_client = new Db(MONGODB, new Server("127.0.0.1", 27017, {auto_reconnect: true}), {native_parser: (process.env['TEST_NATIVE'] != null), retryMiliSeconds:50, logger:logger});
