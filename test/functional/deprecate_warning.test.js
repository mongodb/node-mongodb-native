...
describe('Deprecation Warnings - functional', function () {
  ...
  it.skip('node --no-deprecation flag should suppress all deprecation warnings', function (done) {
    exec(
  ...
  it.skip('node --trace-deprecation flag should print stack trace to stderr', function (done) {
    exec(
  ...
  it.skip('node --throw-deprecation flag should throw error when deprecated function is called', function (done) {
    exec(
