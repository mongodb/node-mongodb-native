    ...
    client.connect(function(err, client) {
      ...
      gridStore.open(function(err, gridStore) {
        ...
        gridStore.chunkCollection().deleteMany({}, function(err) {
          ...
          var file2 = '';
          var file3 = '';
          for (var i = 0; i < gridStore.chunkSize; i++) {
            file1 = file1 + 'x';
          }
          for (var i = 0; i < gridStore.chunkSize; i++) {
            file2 = file2 + 'y';
...
exports.shouldCorrectlyStreamReadFromGridStoreObject = {
  ...
  test: function(configuration, test) {
    ...
    client.connect(function(err, client) {
      ...
      gridStore.writeFile('./test/functional/data/test_gs_working_field_read.pdf', function(
        err,
        result
      ) {
                                          ...
                                          gridStore7.open(function(err, gridStore) {
                                            gridStore.seek(7, GridStore.IO_SEEK_CUR, function(
                                              ...
                                              gridStore.getc(function(err, chr) {
                                                ...
                                                gridStore.seek(-1, GridStore.IO_SEEK_CUR, function(
                                                  err,
                                                  gridStore
                                                ) {
                                                  gridStore.getc(function(err, chr) {
