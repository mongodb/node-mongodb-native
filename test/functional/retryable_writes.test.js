      ...
      if (test.outcome.error) {
        result = result
          ...
          .catch(err => {
            ...
            if (errorLabelsContain) expect(err.errorLabels).to.containSubset(errorLabelsContain);
            if (errorLabelsOmit) expect(err.errorLabels).to.not.containSubset(errorLabelsOmit);
          });
