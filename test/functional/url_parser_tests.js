 ...
 */
exports[
  'Parse mongodb://localhost/db?replicaSet=hello&ssl=prefer&connectTimeoutMS=1000&socketTimeoutMS=2000'
] = {
  metadata: {
    requires: { topology: ['single', 'replicaset', 'sharded', 'ssl', 'heap', 'wiredtiger'] }
  },
...
exports['Write concerns parsing'] = {
  ...
  test: function(configure, test) {
    ...
    test.throws(function() {
      parse(
        'mongodb://localhost/db?safe=true&w=0'
      ), 'w set to -1 or 0 cannot be combined with safe/w/journal/fsync';
    });
    test.throws(function() {
      parse(
        'mongodb://localhost/db?fsync=true&w=-1'
      ), 'w set to -1 or 0 cannot be combined with safe/w/journal/fsync';
    });
    test.done();
  }
...
exports['Read preferences parsing'] = {
  ...
  test: function(configure, test) {
    ...
    test.throws(function() {
      parse(
        'mongodb://localhost/db?readPreference=blah'
