...
var tests = testCase({
  ...
  shouldCorrectlyConnectWithDottedDbName : function(test) {
    var automatic_connect_client = new Db('hello.world', new Server("127.0.0.1", 27017, {auto_reconnect: true}), {native_parser: (process.env['TEST_NATIVE'] != null)});
