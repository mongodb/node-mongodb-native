...
- [🛠️ Runtime and dependency updates](#🛠️-runtime-and-dependency-updates)
...
- [☀️ API usability improvements](#☀️-api-usability-improvements)
...
- [⚙️ Option parsing improvements](#⚙️-option-parsing-improvements)
...
- [⚠️ ALL BREAKING CHANGES](#⚠️-all-breaking-changes)
