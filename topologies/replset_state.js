...
State.prototype.contains = function(address) {
  ...
  // console.log("secondaries " + this.secondaries.map(function(x){
  //   return x.name
  // }))
  // console.log("arbiters " + this.arbiters.map(function(x){
  //   return x.name
  // }))
  // console.log("passives " + this.passives.map(function(x){
  //   return x.name
  // }))
  // console.log("primary " + (this.primary ? this.primary.name : 'null'))
