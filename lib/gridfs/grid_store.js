...
GridStore.prototype.readlines = function(separator, callback) {
  ...
  return executeOperation(this.db.s.topology, readlines, [this, separator, callback]);
};
...
GridStore.prototype.read = function(length, buffer, callback) {
  ...
  return executeOperation(this.db.s.topology, read, [this, length, buffer, callback]);
};
...
GridStore.prototype.seek = function(position, seekLocation, callback) {
  ...
  return executeOperation(this.db.s.topology, seek, [this, position, seekLocation, callback]);
};
