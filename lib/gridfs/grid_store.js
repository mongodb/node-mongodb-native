...
/**
 * @file GridFS is a tool for MongoDB to store files to the database.
...
const fs = require('fs');
const { format: f, inherits, deprecate } = require('util');
 ...
 * @returns {GridStore} a GridStore instance.
 ...
 *
 * @constant DEFAULT_ROOT_COLLECTION
 */
 ...
 * @param {string} fileIdObject The name of the file to look for.
 ...
 * @returns {GridStoreStream} a GridStoreStream instance.
 * @deprecated Use GridFSBucket API instead
 * @param {any} gs
 */
