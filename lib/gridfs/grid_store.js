...
GridStore.prototype.open = function(callback) {
  ...
  return executeOperation(this.db.s.topology, open, [this, callback]);
};
...
GridStore.prototype.getc = function(callback) {
  return executeOperation(this.db.s.topology, getc, [this, callback]);
};

var getc = function(self, callback) {
  if (self.eof()) {
    callback(null, null);
...
GridStore.prototype.puts = function(string, callback) {
  ...
  return executeOperation(this.db.s.topology, this.write.bind(this), [finalString, callback]);
};
...
GridStore.prototype.write = function write(data, close, callback) {
  return executeOperation(this.db.s.topology, _writeNormal, [this, data, close, callback]);
};
...
GridStore.prototype.writeFile = function(file, callback) {
  return executeOperation(this.db.s.topology, writeFile, [this, file, callback]);
};
...
GridStore.prototype.close = function(callback) {
  return executeOperation(this.db.s.topology, close, [this, callback]);
};
...
GridStore.prototype.unlink = function(callback) {
  return executeOperation(this.db.s.topology, unlink, [this, callback]);
};
...
GridStore.prototype.rewind = function(callback) {
  return executeOperation(this.db.s.topology, rewind, [this, callback]);
};
