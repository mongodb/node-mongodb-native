...
GridStore.readlines = function(db, name, separator, options, callback) {
  ...
  // We provided a callback leg
  if(typeof callback == 'function') return readlines(db, name, separator, options, callback);
  // Return promise
  return new promiseLibrary(function(resolve, reject) {
    readlines(db, name, separator, options, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    })
  });
...
var readlines = function(db, name, separator, options, callback) {
...
GridStore.unlink = function(db, names, options, callback) {
  ...
  // We provided a callback leg
  if(typeof callback == 'function') return unlink(self, db, names, options, callback);
  // Return promise
  return new promiseLibrary(function(resolve, reject) {
    unlink(self, db, names, options, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    })
  });
...
var unlink = function(self, db, names, options, callback) {
  // Get the write concern
