...
/**
 * Checks a all options for invalid tls options according to the URI options spec.
 *
 * @param {string} queryString The query string to check
 * @throws {MongoParseError}
 */
function checkTLSOptions(options) {
  ...
  assertRepelOptions(options, 'tlsInsecure', 'tlsAllowInvalidCertificates');
  assertRepelOptions(options, 'tlsInsecure', 'tlsAllowInvalidHostnames');
  assertRepelOptions(
    options,
    'tlsAllowInvalidCertificates',
    'tlsDisableCertificateRevocationCheck'
  );
  assertRepelOptions(options, 'tlsInsecure', 'tlsDisableCertificateRevocationCheck');
  assertRepelOptions(
    options,
    'tlsDisableCertificateRevocationCheck',
    'tlsDisableOCSPEndpointCheck'
  );
  assertRepelOptions(options, 'tlsDisableOCSPEndpointCheck', 'tlsAllowInvalidCertificates');
  assertRepelOptions(options, 'tlsInsecure', 'tlsDisableOCSPEndpointCheck');
}
