 ...
 * @param {Server} topology The server topology for the database. TODO:(neal) type? ReplSet|Mongos
 ...
 * @param {boolean} [options.noListener] TODO:(neal) documentation
...
class Db {
  constructor(databaseName, topology, options) {
    ...
    // if (this.s.noListener) return; TODO:(neal) what did this do?
  }
  get serverConfig() {
   ...
   * @param {boolean} [options.ignoreUndefined] TODO:(neal) documentation
