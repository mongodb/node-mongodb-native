...
Db.prototype.listCollections = function(filter, options) {
  ...
  options = validate(
    ...
    {},
    {
      ...
      cursorFactory: this.serverConfig.capabilities().hasListCollectionsCommand ? CommandCursor : null
    },
    { optionsValidationLevel: this.s.optionsValidationLevel }
  );
...
const renameCollectionSchema = {
  ...
  wtimeout: { type: 'number' },
  j: { type: 'boolean' },
  new_collection: { overrideOnly: true }
};
