 ...
 * @param {Server} topology The server topology for the database. TODO:(ts) type? ReplSet|Mongos
 ...
 * @param {boolean} [options.noListener] TODO:(ts) documentation
...
class Db {
  constructor(databaseName, topology, options) {
    ...
    // if (this.s.noListener) return; TODO:(ts) what did this do?
  }
  get serverConfig() {
   ...
   * @param {boolean} [options.ignoreUndefined] TODO:(ts) documentation
