 ...
 * @deprecated {object} [options.promiseLibrary] A Promise library class the application wishes to use such as Bluebird, must be ES6 compatible
 ...
 */
const Db = deprecateOptions(
  {
    name: 'Db',
    deprecatedOptions: ['promiseLibrary'],
    optionsIndex: 2
  },
