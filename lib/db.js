...
var executeCommand = function(self, command, options, callback) {
  ...
  // } else if(options.readPreference && typeof options.readPreference == 'object') {
  //   var mode = options.readPreference.mode || options.readPreference.preference;
  //   if(mode && typeof mode == 'string') {
  //     options.readPreference = new CoreReadPreference(mode, options.readPreference.tags);
  //   }
  // }
...
Db.prototype.listCollections = function(filter, options) {
  ...
  // Ensure valid readPeference
  if(options.readPeference
    && !(options.readPeference instanceof ReadPreference)
    && typeof options.readPreference == 'object') {
    var mode = options.readPeference.mode || options.readPeference.preference;
    if (mode && typeof mode == 'string') {
      options.readPeference = new ReadPreference(mode, readPreference.tags);
    }
  }
