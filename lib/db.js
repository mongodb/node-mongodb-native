...
var executeCommand = function(self, command, options, callback) {
  ...
  if(options.readPreference) {
    // console.log("-------- readPreference command 0")
    options.readPreference = convertReadPreference(options.readPreference);
  } else {
    // console.log("-------- readPreference command 1")
...
Db.prototype.executeDbAdminCommand = function(selector, options, callback) {
  ...
  if(typeof callback == 'function') {
    ...
    // console.dir(options)
    // console.log(self.s.topology.command.toString())
    ...
    // console.dir(self.s.topology.command)
