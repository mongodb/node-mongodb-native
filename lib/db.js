...
function Db(databaseName, client, options) {
  ...
  this.s = {
    ...
    children: [],
    // Topology
    topology: client ? client.topology : null,
    // Client
    client: client,
    // Options
    options: options,
    ...
    // Get the bson parser
    bson: client && client.topology ? client.topology.bson : null,
  ...
  // Add listeners
  this.s.topology.on('error', createListener(this, 'error', this));
  this.s.topology.on('timeout', createListener(this, 'timeout', this));
  this.s.topology.on('close', createListener(this, 'close', this));
  this.s.topology.on('parseError', createListener(this, 'parseError', this));
  this.s.topology.once('open', createListener(this, 'open', this));
  this.s.topology.once('fullsetup', createListener(this, 'fullsetup', this));
  this.s.topology.once('all', createListener(this, 'all', this));
  this.s.topology.on('reconnect', createListener(this, 'reconnect', this));
}
