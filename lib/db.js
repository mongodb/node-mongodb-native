...
Db.prototype.dropCollection = function(name, options, callback) {
  ...
  return executeOperation(this, dropCollection, [this, cmd, opts, callback]);
};
...
Db.prototype.collections = function(options, callback) {
  if (typeof options === 'function') (callback = options), (options = {});
  return executeOperation(this, collections, [this, options, callback]);
};
...
Db.prototype.setProfilingLevel = function(level, options, callback) {
  if (typeof options === 'function') (callback = options), (options = {});
  return executeOperation(this, setProfilingLevel, [this, level, options, callback]);
};
...
Db.prototype.profilingInfo = function(options, callback) {
  if (typeof options === 'function') (callback = options), (options = {});
  return executeOperation(this, profilingInfo, [this, options, callback]);
};
...
Db.prototype.profilingLevel = function(options, callback) {
  if (typeof options === 'function') (callback = options), (options = {});
  return executeOperation(this, profilingLevel, [this, options, callback]);
};
