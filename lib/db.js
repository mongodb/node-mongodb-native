...
var EventEmitter = require('events').EventEmitter
  ...
  , changeNotifications = require('./changeNotifications')
...
Db.prototype.changes = function(pipeline, options) {
  ...
  if (serverSupportsChangeNotifications) {
    ...
    return this.aggregate([{$changeNotifications:{}}].concat(pipeline), options)
  } else {
    return changeNotifications.createChangeNotificationCursor(this.s.topology, {
