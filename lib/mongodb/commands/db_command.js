...
DbCommand.createCreateIndexCommand = function(db, collectionName, fieldOrSpec, options) {
  ...
  if(options != null && 'object' === typeof options) {
    ...
    dropDups = options['dropDups'] != null ? options['dropDups'] : null;
    v = options['v'] != null ? options['v'] : null;
  }
  ...
  // Set options
  if(finalUnique != null) selector['unique'] = finalUnique;
  if(sparse != null) selector['sparse'] = sparse;
  if(background != null) selector['background'] = background;
  if(dropDups != null) selector['dropDups'] = dropDups;
  if(geoMin != null) selector['min'] = geoMin;
  if(geoMax != null) selector['max'] = geoMax;
  if(v != null) selector['v'] = v;
