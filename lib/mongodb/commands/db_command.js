...
process.inherits(DbCommand, QueryCommand);
...
DbCommand.createDbCommand = function(databaseName, command_hash) {
  return new DbCommand(databaseName + "." + DbCommand.SYSTEM_COMMAND_COLLECTION, QueryCommand.OPTS_NO_CURSOR_TIMEOUT, 0, -1, (command_hash.className == "OrderedHash" ? command_hash : new OrderedHash(command_hash)), null);
};
