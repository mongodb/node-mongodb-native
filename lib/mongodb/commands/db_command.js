...
/**
  Db Command
**/
exports.DbCommand = QueryCommand.extend({
...
exports.DbCommand.createGetLastStatusCommand = function(databaseName) {
  return new exports.DbCommand(databaseName + "." + DbCommand.SYSTEM_COMMAND_COLLECTION, QueryCommand.OPTS_NO_CURSOR_TIMEOUT, 0, -1, new OrderedHash().add('getlasterror', 1), null);              
}
