...
// DbCommand.createCountCommand = function(databaseName, collectionName) {
//   return new DbCommand(databaseName + "." + DbCommand.SYSTEM_COMMAND_COLLECTION, QueryCommand.OPTS_NO_CURSOR_TIMEOUT, 0, -1, new OrderedHash().add('count', 1), null);                  
// }
...
DbCommand.createDbCommand = function(databaseName, command_hash) {
  return new DbCommand(databaseName + "." + DbCommand.SYSTEM_COMMAND_COLLECTION, QueryCommand.OPTS_NO_CURSOR_TIMEOUT, 0, -1, new OrderedHash(command_hash), null);                    
}
