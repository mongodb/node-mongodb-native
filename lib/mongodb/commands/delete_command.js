...
DeleteCommand.prototype.getCommand = function() {
  ...
  return this.parser.fromInt(0) + this.parser.encode_utf8(this.collectionName) + this.parser.fromByte(0) + this.parser.fromInt(0) + this.bson.serialize(this.selector);
}