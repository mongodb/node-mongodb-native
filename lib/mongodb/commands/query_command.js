...
**/
exports.QueryCommand = BaseCommand.extend({
  ...
  */
  getCommand: function() {
    ...
    var command_string = BinaryParser.fromInt(this.queryOptions) + BinaryParser.encode_utf8(this.collectionName) + BinaryParser.fromByte(0);
