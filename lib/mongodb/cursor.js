...
Cursor.prototype.nextObject = function(callback) {
  ...
  if(self.state == Cursor.INIT) {
    ...
    if(this.connection == null) {
      // console.log("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ checkout :: " + this.read)
      // console.log("this.read == 'primary' || this.read == null :: " + (this.read == 'primary' || this.read == null))      
    ...
    // console.log("---------------------------------- this.connection :: " + (this.connection == null))
