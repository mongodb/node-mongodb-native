...
var generateQueryCommand = function(self) {
  ...
  // console.dir(self.readPreference)
  // console.dir(self.read)
  // console.dir(queryOptions)

  // if(self.read == 'secondary')
  if(self.read == ReadPreference.PRIMARY_PREFERRED
    || self.read == ReadPreference.SECONDARY
    || self.read == ReadPreference.SECONDARY_PREFERRED
    || self.read == ReadPreference.NEAREST) {
