 ...
 * @see Db#eval
 */
var Cursor = exports.Cursor = function(db, collection, selector, fields, skip, limit
...
Cursor.prototype.generateQueryCommand = function() {
  ...
  if(this.sortValue != null || this.explainValue != null || this.hint != null || this.snapshot != null
      || this.returnKey != null || this.maxScan != null || this.min != null || this.max != null
      || this.showDiskLoc != null || this.comment != null) {
    ...
    if(this.returnKey != null) specialSelector['$returnKey'] = this.returnKey;
    if(this.maxScan != null) specialSelector['$maxScan'] = this.maxScan;
    if(this.min != null) specialSelector['$min'] = this.min;
    if(this.max != null) specialSelector['$max'] = this.max;
    if(this.showDiskLoc != null) specialSelector['$showDiskLoc'] = this.showDiskLoc;
    if(this.comment != null) specialSelector['$comment'] = this.comment;
