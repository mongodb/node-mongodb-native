...
GridStore.read = function(db, name, length, offset, callback) {
  var args = Array.prototype.slice.call(arguments, 2);
  callback = args.pop();
  length = args.length ? args.shift() : null;
...
GridStore.readlines = function(db, name, separator, callback) {
  var args = Array.prototype.slice.call(arguments, 2);
  callback = args.pop();
  separator = args.length ? args.shift() : null;
...
GridStore.unlink = function(db, names, callback) {
  var self = this;
