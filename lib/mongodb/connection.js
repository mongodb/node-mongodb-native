...
// // listeners
// Connection.prototype.listeners = {};
// 
...
// }
// 
// Connection.prototype.removeListener = function(event, callback) {
//   sys.puts("=================== remove");
// }
// 
// Connection.prototype.emit = function(event, data) {
//   sys.puts("========================== emit: " + event);
//   //sys.puts(sys.inspect(this.listeners[event]));
//   for(var i = 0; i < this.listeners[event].length; i++) {
//     var listener = this.listeners[event][i];
//     // sys.puts("================= data: " + data);
//     // data ? listener(data) : listener();
//     data ? listener.apply(this, [data]) : listener.apply(this, []);
//   }
//   // this.listeners[event].forEach(function(listener) {
//   //   sys.puts(listener);
//   //   data ? listener(data) : listener();
//   // })
//   // if(data)sys.puts("====================================== data: " + data.length);
//   // this.listener(data);
// }
