...
exports.ServerPair = Class({
  init: function(leftServer, rightServer) {
    if(leftServer == null || rightServer == null || !(leftServer instanceof exports.Server) || !(rightServer instanceof exports.Server)) {
    ...
    this.__defineGetter__("masterConnection", function() { 
      if(this.target != null && this.target instanceof exports.Server) return this.target.masterConnection;
  ...
  init: function(servers) {  
    ...
    if(servers.constructor != Array || servers.length == 0) {        
      ...
      servers.forEach(function(server) {
        if(server instanceof exports.Server) count = count + 1;
      })       
    ...
    this.__defineGetter__("masterConnection", function() { 
      ...
      if(this.target != null && this.target instanceof exports.Server) {
