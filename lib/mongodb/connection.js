...
/**
* this function always run command on master connection
* if master connection is down check for new master
* else throw err
**/
Connection.prototype.sendtomaster = function(command) {
  var self = this;
...
// serverCluster implementation is same as master-slave
var ReplSetServers = exports.ReplSetServers = function(serversArr) {
serverlist = serversArr;
serverlistcopy = serversArr;
return  new ServerCluster(serverlist);
};
