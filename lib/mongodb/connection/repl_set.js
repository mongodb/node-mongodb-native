...
ReplSet.prototype.connect = function(parent, options, callback) {
  ...
  for(var i = 0; i < serverConnections.length; i++) {    
    ...
    this.replicasetCheckFunction = function() {
      try {
        console.log("================================================= replicasetCheckFunction")
...
ReplSet.prototype.checkoutReader = function(readPreference) {
  ...
  if(finalReadPreference == 'primary') return this.checkoutWriter();
