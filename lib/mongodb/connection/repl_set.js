...
ReplSet.prototype.connect = function(parent, options, callback) {
  ...
  this.replicasetCheckFunction = function() {
    try {
      ...
      var con = self.checkoutReader(ReadPreference.SECONDARY_PREFERRED);
...
ReplSet.prototype.checkoutReader = function(readPreference, tags) {
  ...
  if((this.readSecondary == true || finalReadPreference == ReadPreference.SECONDARY_PREFERRED || finalReadPreference == ReadPreference.SECONDARY) && Object.keys(this._state.secondaries).length > 0) {
