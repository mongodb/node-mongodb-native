...
ReplSet.prototype.isConnected = function() {
  ...
  // console.dir(this.primary != null)
  // console.dir(this._state.master != null)
  // console.dir(this._state.master.isConnected())
...
var _connectHandler = function(self, candidateServers, instanceServer) {
  return function(err, result) {
    ...
    if(err == null && result.documents[0].hosts != null) {
      ...
      // console.log("=========================================== connect :: 0 :: " + instanceServer.port)
      // console.dir(document)
      ...
      // console.log("====================================================================== possibleHosts")
      // console.dir(possibleHosts)
      // console.log(Array.isArray(candidateServers))
...
ReplSet.prototype.connect = function(parent, options, callback) {
  ...
  this.once("fullsetup", function() {    
    ...
    // console.dir(Object.keys(self._state.addresses))
    // for(var key in self._state.addresses) {
    //   console.log("server " + self._state.addresses[key].port + " :: connected :: " + self._state.addresses[key].isConnected());
    // }
