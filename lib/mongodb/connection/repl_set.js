...
ReplSet.prototype.validateReplicaset = function(result, auths) {
  var self = this;
...
ReplSet.prototype.connect = function(parent, options, callback) {
  ...
  // Clean up state
  replSetSelf._state = {'master':null, 'secondaries':{}, 'arbiters':{}, 'passives':{}, 'errors':{}, 'addresses':{}, 'setName':null, 'errorMessages':[], 'members':[]};
  ...
  for(var i = 0; i < allServers.length; i++) {
    ...
    server.close(function() {
      ...
      if(numberOfServersToClose == 0) {
        // Clear out state
        self._state = {'master':null, 'secondaries':{}, 'arbiters':{}, 'passives':{}, 'errors':{}, 'addresses':{}, 'setName':null, 'errorMessages':[], 'members':[]};
      }
