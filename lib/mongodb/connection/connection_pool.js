...
var _connect = function(_self) {
  return new function() {
    ...
    connection.on("error", function(err, connection) {
      console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! error :: " + _self.socketOptions.host + ":" + _self.socketOptions.port)
      
      numberOfErrors++;
      // If we are already disconnected ignore the event
      if(connectionStatus !== 'disconnected') {
        console.log("----------------------------------------------------- emitters")
        console.dir(_self._events)
    ...
    connection.on("close", function() {
      console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! close :: " + _self.socketOptions.host + ":" + _self.socketOptions.port)
    ...
    connection.on("timeout", function(err, connection) {
      console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! timeout :: " + _self.socketOptions.host + ":" + _self.socketOptions.port)
