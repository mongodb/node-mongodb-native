...
Server.prototype.close = function(callback) {  
  // console.log("====================================== Server.prototype.close :: 0")
  ...
  // console.log("====================================== Server.prototype.close :: 1")
...
Server.prototype.connect = function(dbInstance, options, callback) {
  // console.log("=================================================== SERVER connect :: " + this.host + ":" + this.port)
  ...
  // console.log("=================================================== SERVER connect :: " + this.host + ":" + this.port + " :: 0")
  ...
  // console.log("=================================================== SERVER connect :: " + this.host + ":" + this.port + " :: 1")

  // Set up on connect method
  connectionPool.on("poolReady", function() {   
    // console.log("=========================================== CONNECTION POOL READY :: " + server.host + ":" + server.port)
  ...
  connectionPool.on("timeout", function(err) {
    ...
    //   server.removeAllListeners()          
    // } else {
    //   eventReceiver.emit("timeout", server);      
    // }
    // 
    // // If we are a member of a replicset delegate the responsibility to handle any erros to 
    // // the replicaset code
    // if(server.replicasetInstance == null) {
    // //   server.emit("timeout", err);
    // // } else {
    //   // Emit error
  ...
  connectionPool.on("error", function(message) {   
    ...
    // console.log("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^");
    // console.log("^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^");
    // console.log(server.replicasetInstance != null);
  ...
  connectionPool.on("close", function() {
    // console.log("=========================================== CONNECTION POOL CLOSE :: " + server._serverState)    
    // If pool connection is already closed
    if(server._serverState === 'disconnected') return;
    // Set server state to disconnected
    server._serverState == 'disconnected';
    ...
    if(typeof callback === 'function') {
      ...
      // console.log("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ 1")      
      // console.dir(server.listeners("close"));
    ...
    // console.log("=========================================== CONNECTION POOL CLOSE")
    // // Force close the pool
    // connectionPool.stop();
    // // Keep the db we don't want to emit an error on
  ...
  // console.log("=================================================== SERVER connect :: " + this.host + ":" + this.port + " :: 2")
  // Boot up connection poole, pass in a locator of callbacks
  connectionPool.start();
  // console.log("=================================================== SERVER connect :: " + this.host + ":" + this.port + " :: 3")
}
...
Server.prototype.checkoutWriter = function(read) {
  // console.log("---------------------------------------- checkoutWriter :: " + this._readPreference)
...
Server.prototype.checkoutReader = function() {
  // console.log("---------------------------------------- checkoutReader :: " + this._readPreference)
