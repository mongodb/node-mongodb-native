...
Server.prototype.connect = function(dbInstance, options, callback) {
  ...
  connectionPool.on("error", function(message) {     
    ...
    if(server._serverState === 'connecting' && firstCall) {
      ...
      // console.log("----------------------------------------------------- ERRRRRRRRRRRRRRRORR")
      // console.dir("server._serverState :: " + server._serverState)
...
Server.prototype.checkoutStatsConnection = function() {
  return this.connectionPool.checkoutStatsConnection();
}
