...
PingStrategy.prototype.checkoutConnection = function(tags, secondaryCandidates) {
  // console.log("==================================== PingStrategy.prototype.checkoutConnection")
  ...
  // console.log("============================ 0 finalCandidates :: " + finalCandidates.length)
  // for(var i = 0; i < finalCandidates.length; i++) {
  //   console.log(finalCandidates[i].port + " :: " + finalCandidates[i].runtimeStats['pingMs']);
  // }
  ...
  // console.log("============================ 1 finalCandidates :: " + finalCandidates.length)
  // for(var i = 0; i < finalCandidates.length; i++) {
  //   console.log(finalCandidates[i].port + " :: " + finalCandidates[i].runtimeStats['pingMs']);
  // }
  ...
  // console.log("============================ 2 finalCandidates :: " + finalCandidates.length)
  // for(var i = 0; i < finalCandidates.length; i++) {
  //   console.log(finalCandidates[i].port + " :: " + finalCandidates[i].runtimeStats['pingMs']);
  // }

  // console.log("=========================== connection :: " + connection.socketOptions.port)
