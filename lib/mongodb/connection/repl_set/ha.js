...
HighAvailabilityProcess.prototype.start = function() {  
  ...
  if(candidate_servers.length == 0) {
    return setTimeout(_handle(this), 1000);
  }
  ...
  newServer.once("error", _handle(this));
  newServer.once("close", _handle(this));
  newServer.once("timeout", _handle(this));
