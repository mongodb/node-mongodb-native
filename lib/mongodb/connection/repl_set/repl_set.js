...
var ReplSet = exports.ReplSet = function(servers, options) {
  ...
  Object.defineProperty(this, "socketTimeoutMS", {
      enumerable: true
    , get: function () { return self.options.socketOptions.socketTimeoutMS; }
    , set: function (value) { 
      console.log("+++++++++++++++++++++++++++++ replset socketTimeoutMS :: " + value)
      // Set the socket timeoutMS value
      self.options.socketOptions.socketTimeoutMS = value;
