...
ReplSetServers.prototype.connect = function(parent, options, callback) {
  ...
  //   if(this.strategyInstance instanceof PingStrategy) {
  //     this.strategyInstance.stop(function(err, result) {})
  //   }
  //   // Create a new instance
  //   this.strategyInstance = new PingStrategy(this);
  // } else if(this.strategy == 'statistical') {
  //   // Stop any existing instance
  //   if(this.strategyInstance instanceof StatisticsStrategy) {
  //     this.strategyInstance.stop(function(err, result) {})
  //   }
  //   // console.log("---------------------------------------------------------------- statistical")
  //   // Set strategy as statistical
  //   this.strategyInstance = new StatisticsStrategy(this);
  //   // Enable recording of query statistics
...
ReplSetServers.prototype.checkoutReader = function() {
  ...
  // console.dir(this.readSecondary)
  // console.dir(this._readPreference)
...
ReplSetServers.prototype.close = function(callback) {
  ...
  for(var i = 0; i < allServers.length; i++) {
    ...
    server.close(function() {
      console.log("   ====================================== ReplSetServers::close:: 2:0")
      ...
      console.log("   ====================================== ReplSetServers::close:: 2:1")
      // If we are finished perform the call back
      if(numberOfServersToClose == 0 && typeof callback === 'function') {
        console.log("   ====================================== ReplSetServers::close:: 2:3")
        // Remove all the listeners
        self.removeAllListeners();
        
        // Ensure the strategy instance is stopped if any
        if(self.strategyInstance != null) {
          console.log("   ====================================== ReplSetServers::close:: 2:4")
          self.strategyInstance.stop(function(err, result) {
            console.log("   ====================================== ReplSetServers::close:: 2:5")
            callback(null);            
          });
        } else {
          console.log("   ====================================== ReplSetServers::close:: 2:6")
          callback(null);          
        }        
      } else if(numberOfServersToClose == 0) {
        console.log("   ====================================== ReplSetServers::close:: 3:0")
        // Remove all the listeners
        self.removeAllListeners();
      }
    })
