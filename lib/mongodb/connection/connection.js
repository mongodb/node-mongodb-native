...
// Reset all handlers
var resetHandlers = function(self) {  
  self.eventHandlers = {error:[], connect:[], close:[], end:[], timeout:[]};  
  self.connection.removeAllListeners("connect")
  self.connection.removeAllListeners("data")
  self.connection.removeAllListeners("end")
  self.connection.removeAllListeners("timeout")
  self.connection.removeAllListeners("drain")
