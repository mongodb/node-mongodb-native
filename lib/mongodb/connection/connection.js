...
Connection.prototype.isConnected = function() {
  ...
  // console.log("this.connection.destroyed = " + this.connection.destroyed)
  // console.log("this.connection.writable = " + this.connection.writable)
  // console.log("this.connection.readable = " + this.connection.readable)
  
  return this.connected && !this.connection.destroyed && this.connection.writable && this.connection.readable;
  // return this.connected && !this.connection.destroyed;
  ...
  try {
    ...
    if(Array.isArray(command)) {
      for(var i = 0; i < command.length; i++) {
        // console.log("======================================================= yo :: 1")
        // console.dir(command[i].toBinary())
        // console.log("======================================================= yo :: 2")
