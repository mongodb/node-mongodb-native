...
var connectHandler = function(self) {
  return function() {    
    // console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! connectHandler :: 0 :: " + self.socketOptions.host + ":" + self.socketOptions.port)
    // Set connected
    self.connected = true;
...
var timeoutHandler = function(self) {  
  return function() {
    // console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! timeoutHandler :: " + self.socketOptions.host + ":" + self.socketOptions.port);
...
var errorHandler = function(self) {  
  return function(err) {
    // console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! errorHandler :: " + self.socketOptions.host + ":" + self.socketOptions.port);
    // console.dir(err);
    // Set connected to false
    self.connected = false;
    // Emit error
...
var closeHandler = function(self) {
  return function(hadError) { 
    // console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! closeHandler :: " + self.socketOptions.host + ":" + self.socketOptions.port);
