...
Connection.prototype.write = function(command, callback) {
  // console.log("======================================== Connection.prototype.write :: " + this.id)
  try {
    // // console.dir(this.writeSteam)
    // console.log("writeSteam.writable = " + this.writeSteam.writable);
    // console.log("writeSteam.readable = " + this.writeSteam.readable);
    // console.log("writeSteam.destroyed = " + this.writeSteam.destroyed);
...
var closeHandler = function(self) {
  return function(hadError) { 
    // console.log("=================================================== closeHandler :: " + self.socketOptions.host + ":" + self.socketOptions.port + " :: " + self.connected)
