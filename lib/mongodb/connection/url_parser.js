...
exports.parse = function(url, options) {
  ...
  if(connection_part.indexOf("@") != -1) {
    var last_at_index = connection_part.lastIndexOf('@');

    auth_part = connection_part.substring(0, last_at_index);
    connection_part = connection_part.substring(last_at_index + 1);
  }
