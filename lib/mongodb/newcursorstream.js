...
util.inherits(NewCursorStream, Transform);
 ...
 *
 * @class Represents a NewCursorStream.
 * @param {Cursor} cursor a cursor object that the stream wraps.
 * @return {Stream}
 */
function NewCursorStream(cursor, options) {
 ...
 */
NewCursorStream.prototype.readable;
 ...
 * @api private
 */
NewCursorStream.prototype._init = function() {
 ...
 * @api private
 */
NewCursorStream.prototype._next = function() {
  if (this._destroyed) return;
  var self = this;
 ...
 * @api private
 */
NewCursorStream.prototype._onNextObject = function(err, doc) {
 ...
 * @api private
 */
NewCursorStream.prototype._transform = function(chunk, encoding, done) {
 ...
 * Kill the cursor.
 */
NewCursorStream.prototype.destroy = function(err) {
  if (this._destroyed) return;
...
module.exports = exports = NewCursorStream;
