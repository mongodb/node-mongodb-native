 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the count method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * Drop the collection
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the drop method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the findAndModify method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Array}  sort - if multiple docs match, choose the first one in the specified sort order as the object to manipulate
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the findAndRemove method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} query query object to locate the object to modify
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the find method or null if an error occured.
 ...
 * @param {Object} query query object to locate the object to modify
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the findOne method or null if an error occured.
 * @return {Cursor} returns a cursor to the query
 * @api public
 */
 ...
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the createIndex method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} fieldOrSpec fieldOrSpec that defines the index.
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the ensureIndex method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the indexInformation method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {String} name
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dropIndex method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dropAllIndexes method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @deprecated
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dropIndexes method or null if an error occured.
 * @return {null}
 * @api private
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the reIndex method or null if an error occured.
 * @return {null}
 * @api public
**/
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the mapReduce method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the group method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the options method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the isCapped method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the indexExists method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Objects} [options] options for the map reduce job.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the geoNear method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Number} y point to search on the y axis, ensure the indexes are ordered in the same order.
 * @param {Objects} [options] options for the map reduce job.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the geoHaystackSearch method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the indexes method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the aggregate method or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the stats method or null if an error occured.
 * @return {null}
 * @api public
 */
