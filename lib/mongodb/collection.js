...
Collection = function(db, collectionName, pkFactory) {
  this.db = db;
...
Collection.prototype = {
  set hint(value) {
    this.internalHint = this.normalizeHintField(value);
  },
  get hint() { return this.internalHint;}
};
...
Collection.prototype.createIndex = function(callback, fieldOrSpec, unique) {
