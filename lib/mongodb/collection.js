 ...
 *  - **allowDiskUsage** {Boolean, default:false}, allowDiskUsage lets the server know if it can use disk to store temporary results for the aggregation (requires mongodb 2.6 >).
 *
 ...
 * @api public
 */
Collection.prototype.initializeBulkOp = unordered.initializeBulkOp;
 ...
 * @api public
 */
Collection.prototype.initializeOrderedBulkOp = ordered.initializeOrderedBulkOp;
