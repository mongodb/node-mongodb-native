...
Db.prototype.command = function(selector, options, callback) {
  ...
  // console.dir(options)
  this.executeDbCommand(selector, options, function(err, results) {
    if(err) return callback(err, null);
  ...
  // // Add the maxTimeMS option
  // if(typeof options.maxTimeMS == 'number') {
  //   _options.maxTimeMS = options.maxTimeMS;
  // }

  // // Set up the options
  // var cursor = new Cursor(this
  //   , new Collection(this, DbCommand.SYSTEM_COMMAND_COLLECTION), selector, {}, _options);
