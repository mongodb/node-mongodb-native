 ...
 *  - **checkKeys** {Boolean, default:true}, override the checking of keys on documents being serialize (caution might increase the chance of an injection attack)
 * 
 * Deprecated Options 
...
function Db(databaseName, serverConfig, options) {
  ...
  try {
    ...
    this.bson.checkKeys = this.options.checkKeys == null ? true : this.options.checkKeys;    
    ...
    this.bson_serializer.checkKeys = this.options.checkKeys == null ? true : this.options.checkKeys;
  } catch (err) {
