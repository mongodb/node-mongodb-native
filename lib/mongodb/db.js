...
var __executeQueryCommand = function(self, db_command, options, callback) {
  ...
  console.log("============================================================ __executeQueryCommand BEFORE");
  console.dir(read);
  console.dir(self.serverConfig.isMongos())
  // console.dir(db_command);
  console.dir(db_command.queryOptions)
  ...
  console.log("============================================================ __executeQueryCommand AFTER");
  console.dir(db_command.query);
  console.dir(db_command.queryOptions)
