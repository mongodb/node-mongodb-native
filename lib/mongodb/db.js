...
exports.Db = Class({ 
  ...
  open: function(callback) {
    ...
    if(self.serverConfig instanceof mongo.Server) {
      ...
      var serverConnections = self.serverConfig instanceof mongo.ServerPair ? [self.serverConfig.leftServer, self.serverConfig.rightServer] : self.serverConfig.servers;
