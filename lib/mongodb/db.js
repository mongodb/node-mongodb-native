 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the index information or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the options or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the collection names or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the collection or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the collections or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the eval or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dereference or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the logout or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} [options] the options
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the authentication or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {String} password password.
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the addUser or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {String} username username.
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the removeUser or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {String} collectionName the collection name we wish to access.
 * @param {Object} [options] returns option results.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the createCollection or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dropCollection or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the renameCollection or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the lastError or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Object} [options] returns option results.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the previousErrors or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Object} [options] returns option results.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the resetErrorHistory or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the createIndex or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Object} fieldOrSpec fieldOrSpec that defines the index.
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the ensureIndex or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 *
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the cursorInfo or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dropIndex or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the reIndex or null if an error occured.
 * @api public
**/
 ...
 * @param {String} collectionName the name of the collection.
 * @param {Object} [options] additional options during update.
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the indexInformation or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * Drop a database.
 *
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the dropDatabase or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the results from the stats or null if an error occured.
 * @return {null}
 * @api public
 */
 ...
 * @param {Function} callback this will be called after executing this method. The first paramter will contain the Error object if an error occured, or null otherwise. While the second paramter will contain the db instance or null if an error occured.
 * @return {null}
 * @api public
 */
