...
process.mixin(require("mongodb/bson/binary_parser"));
...
process.mixin(require("mongodb/collection"));
process.mixin(require("mongodb/cursor"));
process.mixin(require("mongodb/connection"));
process.mixin(require("mongodb/admin"));

process.mixin(require("mongodb/goog/math/integer"));
process.mixin(require("mongodb/goog/math/long"));
