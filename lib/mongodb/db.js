...
var _executeAuthCreateUserCommand = function(self, username, password, options, callback) {
  ...
  // Get the error options
  var commandOptions = _getWriteConcern(self, options);
  commandOptions.w = commandOptions.w == null ? 1 : commandOptions.w;
