...
Db.prototype.collection = function(collectionName, options, callback) {
  ...
  if(options && options.safe || this.strict) {
    ...
    // console.log("------------------------------------- collection 2")//" :: " + callback.toString())
...
Db.prototype.addUser = function(username, password, callback) {
  ...
  this.collection(DbCommand.SYSTEM_USER_COLLECTION, function(err, collection) {
    // Update system user collection , if user exists password will be updated, if no - user will be created
    collection.update({user: username},{user: username, pwd: userPassword}, {upsert: true, safe:true}, function(err, documents) {
      // Ensure we return the actual document inserted to avoid breaking backward compatibility
...
Db.prototype._registerHandler = function(db_command, raw, connection, callback) {
  ...
  if(chained) {
    // console.log("=============================================== Db.prototype._registerHandler :: 0")
    ...
    // console.log("=============================================== Db.prototype._registerHandler :: 1")
...
var __retryCommandOnFailure = function(self, retryInMilliseconds, numberOfTimes, command, db_command, options, callback) {
  // console.log("__retryCommandOnFailure ================================== this._state :: " + this._state);
  ...
  var retryFunction = function(_self, _numberOfRetriesDone, _retryInMilliseconds, _numberOfTimes, _command, _db_command, _options, _callback) {
    // console.dir("================================================================= __retryCommandOnFailure :: 0")
    
    _self.serverConfig.connect(_self, {}, function(err, result) {    
      // console.dir("================================================================= __retryCommandOnFailure :: 1 :: " + _numberOfRetriesDone)
      // console.dir(err)      
      ...
      if(err != null && _numberOfRetriesDone > 0) {        
        // console.dir("================================================================= __retryCommandOnFailure :: 2")
        // console.log("========================================= RETRYING :: 0")
        // console.log("========================================= RETRYING :: 0")
        // console.log("========================================= RETRYING :: 0")
        ...
        _self.serverConfig.close(function(err) {
          ...
          // console.log("========================================= RETRYING :: 1")
          // console.log("========================================= RETRYING :: 1")
          // console.log("_retryInMilliseconds :: " + _retryInMilliseconds)
          // Retry the connect
          setTimeout(function() {
        ...
        // console.dir("================================================================= __retryCommandOnFailure :: 3")
        ...
        // console.dir("================================================================= __retryCommandOnFailure :: 4")
        ...
        // console.dir("================================================================= __retryCommandOnFailure :: 5")
        // console.log("====================================================== EXECUTE :: 0")
        // console.dir(_db_command)
        _self._state = 'connected';
        // Execute command
        command(_self, _db_command, _options, function(err, result) {
        ...
        // console.dir("================================================================= __retryCommandOnFailure :: 6")
        _self._state = 'connecting';
        // Force close the current connections
        _self.serverConfig.close(function(err) {
          // Retry the connect
...
Db.prototype._executeQueryCommand = function(db_command, options, callback) {
  ...
  // Node
  // console.log("this.serverConfig.isConnected() = " + this.serverConfig.isConnected())
  // console.log("this.serverConfig.autoReconnect = " + this.serverConfig.autoReconnect)
  ...
  if(this._state == 'connecting' && this.serverConfig.autoReconnect) {
    ...
    // console.log("this.serverConfig.isReconnecting() = " + this.serverConfig.isReconnecting())
    // console.log("this.serverConfig.isConnected() = " + this.serverConfig.isConnected())
    // console.log("this.serverConfig.autoReconnect = " + this.serverConfig.autoReconnect)
...
var __executeInsertCommand = function(self, db_command, options, callback) {
  ...
  if(callback instanceof Function) {
    // console.log("----------------------------------------------- __executeInsertCommand :: 0:1")
    // Ensure we have a valid connection
    if(connection == null) {
      return callback(new Error("no open connections"));
    } else if(connection instanceof Error) {
    ...
    if(safe != null && safe != false) {
      // console.log("----------------------------------------------- __executeInsertCommand :: 0:2")
  ...
  // console.dir(self._callBackStore)
...
Db.prototype._executeInsertCommand = function(db_command, options, callback) {  
  ...
  // console.log("self._state = " + self._state)
  // console.log("this.serverConfig.autoReconnect = " + this.serverConfig.autoReconnect)
  // console.log("this.serverConfig.isConnected() = " + this.serverConfig.isConnected())
  ...
  // } else if(!this.serverConfig.isConnected() && this.serverConfig.autoReconnect && this.state != 'connecting') {
    // console.log("_executeInsertCommand ==================================================== 1")
    this._state = 'connecting';
    // Retry command
