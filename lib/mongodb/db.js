 ...
 *  - **bufferMaxEntries** {Boolean, default: 0}, sets a cap on how many operations the driver will buffer up before giving up on getting a working connection, default is 0 which is unlimited
 * 
 * Deprecated Options 
...
function Db(databaseName, serverConfig, options) {
  ...
  this.bufferMaxEntries = typeof this.options['bufferMaxEntries'] == 'number' ? this.options['bufferMaxEntries'] : 0;
...
var _executeAuthCreateUserCommand = function(self, username, password, options, callback) {
  ...
  var roles = options.roles != null ? options.roles : [];
...
var __executeQueryCommand = function(self, db_command, options, callback) {
  ...
  if(typeof callback === 'function' && !onAll) {
    ...
    // console.log("================================================")
    // console.dir(self.bufferMaxEntries)
