...
function Db(databaseName, serverConfig, options) {
  ...
  if(this.options.strict == null && this.options.safe == null) {
    ...
    console.log("=   allowed values of [true | false | {w:n, wtimeout:n} | {fsync:true}]     =");
    ...
    console.log("=                                                                           =");
    console.log("=  This message will disapear when the default safe is set on the driver Db =");
    console.log("=============================================================================");
  }
