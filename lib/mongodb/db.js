 ...
 *
 * Options
 *  - **strict** {Boolean, default:false}, set driver in strict mode.
 ...
 *
 * @param {String} collectionName the name of the collection that we wish to reindex.
 * @param {Function} callback returns the results.
 * @api public 
**/
Db.prototype.reIndex = function(collectionName, callback) {
  this._executeQueryCommand(DbCommand.createReIndexCommand(this, collectionName), callback);  
};
