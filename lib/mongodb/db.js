/**
 * modified by Rocket Pack Ltd. 2011 (in accordance with Apache 2.0)
 */
...
Db.prototype.open = function(callback) {
  ...
  if(self.serverConfig instanceof Server) {
    ...
    self.serverConfig.connection.addListener("data", function(message) {
      ...
      // Remove the listener
      var listenerFn = self.listeners(reply.responseTo.toString())[0];
      if (listenerFn != null)
        self.removeListener(reply.responseTo.toString(), listenerFn);
    });
