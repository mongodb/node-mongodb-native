...
Db.prototype.collectionNames = function(callback, collection_name) {
  ...
  this.collectionsInfo(function(reply) {
...
Db.prototype.collections = function(callback) {
  ...
  this.collectionNames(function(documents) {
    var collections = [];
...
/**
  Create Collection
**/
Db.prototype.createCollection = function(callback, collectionName) {
