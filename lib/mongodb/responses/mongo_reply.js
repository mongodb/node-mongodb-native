...
MongoReply.prototype.parseBody = function(binary_reply, bson, raw, callback) {
  ...
  if(this.messageLength > docLimitSize) {
    ...
    var parseFunction = function(_self, _binary_reply, _batchSize, _numberReturned) {
      ...
      // console.log("===================================================================")
      // console.dir(_binary_reply.toString('hex'))
      // require('fs').writeFileSync("/Users/christiankvalheim/coding/projects/node-mongodb-native/" + new Date().getTime() + "_" + _self.responseTo + ".txt", _binary_reply.slice(_self.index).toString('hex'), 'ascii');
    ...
    // console.log("===================================================================")
    // console.dir(_binary_reply.toString('hex'))
    // require('fs').writeFileSync("/Users/christiankvalheim/coding/projects/node-mongodb-native/" + new Date().getTime() + "_" + this.responseTo + ".txt", binary_reply.slice(this.index).toString('hex'), 'ascii');
