...
// Exports Long value
var Timestamp = exports.Timestamp = exports.Long = Long;

function BSON () {};

// expose TODO move to bottom?
exports.BSON = BSON;
...
BSON.encodeBoolean = function(bool) {
  ...
  if(value == null) {
    ...
    if(value > BSON.BSON_INT32_MAX || value < BSON.BSON_INT32_MIN) {
      ...
      encoded_string += BinaryParser.fromByte(BSON.BSON_DATA_INT)
                      + variable_encoded
                      + BSON.encodeInt(Integer.fromInt(value));
    }
    ...
    encoded_string += BinaryParser.fromByte(BSON.BSON_DATA_ARRAY)
                    + variable_encoded
                    + BSON.encodeInt(Integer.fromInt(object_string.length + 4 + 1))
                    + object_string
    ...
    encoded_string += BinaryParser.fromByte(BSON.BSON_DATA_BINARY)
                    + variable_encoded
                    + BSON.encodeInt(Integer.fromInt(object_string.length - 1))
                    + object_string;
...
var Code = exports.Code = function Code (code, scope) {
  this.code = code;
...
var DBRef = exports.DBRef = function DBRef (namespace, oid, db) {
