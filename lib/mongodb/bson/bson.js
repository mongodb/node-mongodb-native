  ...
  while(!done) {
    ...
    while(keys.length > 0) {
      ...
      if(value == null) {
        ...
        totalLength += (name != null ? (name.length + 1) : 0) + (value.length + 4 + 1 + 1);
  ...
  while(!done) {
    ...
    while(keys.length > 0) {
      ...
      if(value == null) {
        ...
        index = index + 4;
        // Write the string
        buffer.write(value, index, 'binary');
        // Update index
        ...
        buffer.write(clean_regexp, index, 'binary');
        // Update the index
        index =  index + clean_regexp.length + 1;
        ...
        // Write the string
        buffer.write(codeString, index, 'binary');
        // Update index
