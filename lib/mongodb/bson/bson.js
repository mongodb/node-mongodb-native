...
var locate_chr_end_index = function(data, locate_value, index) {        
  var chr_value = locate_value.charCodeAt(0);
  for(var i = index; i < data.length; i++) {
    if(data[i] == chr_value) return i;
  }        
}
...
// Decode the int
var decodeUInt8 = function(array, index) {
  return array[index];
}
...
BSON.deserialize = function(data, is_array_item, returnData, returnArray) {
  ...
  var size = decodeUInt32(data, 0);
  // Adjust index
  index = index + 4;

  while(index < data.length) {
   // Read the first byte indicating the type of object
   var type = decodeUInt8(data, index);
   // Start index
   var insert_index = 0;
   ...
   switch (type) {
      case BSON.BSON_DATA_STRING:
        ...
        var string_size = decodeUInt32(data, index);
      ...
      case BSON.BSON_DATA_INT:
        ...
        var value = decodeUInt32(data, index);
      ...
      case BSON.BSON_DATA_LONG:
        ...
        // Read the number value
        var low_bits = decodeUInt32(data, index);
        var high_bits = decodeUInt32(data, index + 4);
        // Create to integers
      ...
      case BSON.BSON_DATA_OBJECT:
        ...
        var object_size = decodeUInt32(data, index);
      ...
      case BSON.BSON_DATA_ARRAY:
        ...
        // Read the size of the object
        var array_size = decodeUInt32(data, index);
      ...
      case BSON.BSON_DATA_BOOLEAN:
        ...
        // Read the length of the string (next 4 bytes)
        var boolean_value = decodeUInt8(data, index);
      ...
      case BSON.BSON_DATA_CODE_W_SCOPE:
        ...
        var total_code_size = decodeUInt32(data, index)
        index = index + 4;
        var string_size = decodeUInt32(data, index)
        index = index + 4;
      ...
      case BSON.BSON_DATA_BINARY:
        ...
        var number_of_bytes = decodeUInt32(data, index);
        index = index + 4;

        // Decode the subtype
        var sub_type = decodeUInt8(data, index);
        index = index + 1;
