...
BSON.serialize = function serialize(object, checkKeys, asBuffer) {
  ...
  if(object instanceof Object) {
    var totalLength = BSON._encodeObject(buffers, null, object, checkKeys == null ? false : checkKeys);
...
BSON._encodeValue = function(buffers, elementName, value, checkKeys) {
  var objectLength = 0;
  ...
  if(value == null) {
    ...
    buffers.push(new Buffer([BSON.BSON_DATA_OBJECT]));    
    objectLength += BSON._encodeObject(buffers, elementName, value, checkKeys);
  }
...
BSON._encodeCode = function(buffers, name, value) {
  ...
  var totalObjectLength = value.code instanceof Function ? BSON._encodeString(codeStringBuffers, null, value.code.toString()) 
                                    : BSON._encodeString(codeStringBuffers, null, value.code);
  var scopeBuffers = [];
...
BSON._encodeObject = function(buffers, name, object, checkKeys) {
  ...
  for(var elementName in object) {
    ...
    objectLength += BSON._encodeValue(objectBuffers, elementName, value, checkKeys);
  }
