...
BSON.calculateObjectSize = function(object) {
  ...
  while(!done) {
    ...
    while(keys.length > 0) {
      ...
      if(value == null) {
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (1);
        totalLength += (name != null ? (name.length + 1) : 0) + (1);
      } else if(Array.isArray(value)) {
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (4 + 1) + 1;
        totalLength += (name != null ? (name.length + 1) : 0) + (4 + 1) + 1;
        ...
        if(value >= BSON.BSON_INT32_MAX || value < BSON.BSON_INT32_MIN) {                
          // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (8 + 1);
          totalLength += (name != null ? (name.length + 1) : 0) + (8 + 1);
        } else {                
          // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (4 + 1);
          totalLength += (name != null ? (name.length + 1) : 0) + (4 + 1);
        }
        ...
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (1 + 1);
        totalLength += (name != null ? (name.length + 1) : 0) + (1 + 1);
      } else if(value instanceof Date) {
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (8 + 1);
        totalLength += (name != null ? (name.length + 1) : 0) + (8 + 1);
      } else if(typeof value == 'string') {
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (unescape(encodeURIComponent(value)).length + 4 + 1 + 1);
        totalLength += (name != null ? (name.length + 1) : 0) + (Buffer.byteLength(value, 'utf8') + 4 + 1 + 1);
        // totalLength += (name != null ? (new Buffer(name, 'utf8').length + 1) : 0) + (value.length + 4 + 1 + 1);
      } else if(value instanceof ObjectID || (value.id && value.toHexString)) {
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (12 + 1);
        totalLength += (name != null ? (name.length + 1) : 0) + (12 + 1);
      } else if(value instanceof Binary) {
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (value.position + 1 + 4 + 1);
        totalLength += (name != null ? (name.length + 1) : 0) + (value.position + 1 + 4 + 1);
        ...
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + (clean_regexp.length + 1 + options_array.length + 1 + 1);
        totalLength += (name != null ? (name.length + 1) : 0) + (clean_regexp.length + 1 + options_array.length + 1 + 1);
        ...
        // totalLength += (name != null ? (unescape(encodeURIComponent(name)).length + 1) : 0) + 4 + (value.code.toString().length + 1) + 4;
        totalLength += (name != null ? (name.length + 1) : 0) + 4 + (value.code.toString().length + 1) + 4;
        totalLength += (4 + 1 + 1);
...
BSON.encodeObjectNoRec = function(buffer, object, checkKeys) {
  ...
  // While meeting
  while(!done) {
    // keys = (keys == null) ? Object.keys(currentObjectStored.keys) : keys;
    ...
    while(currentObjectStored.keys.length > 0) {
      ...
      if(currentObjectStored.keys.length == 0) {
        ...
        if(stack.length > 0) {  
          ...
          // debug("======================================================")
          // debug(currentObjectStored.object instanceof Code)
          // debug()
          
          // If we have a Code object write the size of the object
          if(currentObjectStored.object instanceof Code) {
            debug("===================== length :: " + (index - currentObjectStored.index))
            debug(currentObjectStored.index)
          }
    ...
    if(stack.length > 0) {          
      // Write the current object size out
      // Pack the size of the total buffer length
      size = currentObjectStored.endIndex - currentObjectStored.index + 16;      
      // Write the size of the string to buffer
      buffer[currentObjectStored.index + 3] = (size >> 24) & 0xff;     
      buffer[currentObjectStored.index + 2] = (size >> 16) & 0xff;
      buffer[currentObjectStored.index + 1] = (size >> 8) & 0xff;
  ...
  //       }
  //       // Calculate size
  //       // size = unescape(encodeURIComponent(value)).length + 1;
  //       size = Buffer.byteLength(value) + 1;
  //       // Write the size of the string to buffer
  //       buffer[index + 3] = (size >> 24) & 0xff;     
  //      buffer[index + 2] = (size >> 16) & 0xff;
  ...
  //       stack.push({keys:keys, object:currentObject, index: objectIndex});
  //       currentObject = ordered_values;
  //       keys = Object.keys(ordered_values);
  //       break;
  //     } else if(value instanceof Code) {
  ...
  // 
  //       // Make space for the size of the code
  //       index = index + 4;
  //       
  //       // Convert value to string
  //       var codeString = value.code.toString();        
  //       // Calculate size
  //       size = Buffer.byteLength(codeString) + 1;
  //               
  //       // Write the size of the string to buffer
  //       buffer[index + 3] = (size >> 24) & 0xff;     
  //      buffer[index + 2] = (size >> 16) & 0xff;
  ...
  //       
  //       // Push object on stack to process sub fields
  //       stack.push({keys:keys, object:currentObject, index: objectIndex, codeStartIndex:codeStartIndex});
  //       currentObject = value.scope;
  //       keys = Object.keys(value.scope);
  //       break;
  //     } else if(typeof value == 'object') {
  ...
  //     }
  //     
  //     // Finished up the object, but only if we are not to deep
  //     if(keys.length == 0) {
  //       debug("===================================== keys finished up")
  //       // pop the object
  //       currentObjectStored = stack.pop();
  //       
  //       debug(inspect(currentObjectStored))
  //       
  //       
  //       // // Calculate object final size
  ...
  //       // // Set object Index to zero
  //       // objectIndex = 0;        
  //       // // Signal finished up object
  //       // finished = true;
  //     }
  //   }
  //   
  ...
  //     // buffer[size - 1] = 0;      
  //     // 
  //     // // Write current index position if we have one
  //     // if(currentObjectStored != null && currentObjectStored.index > 0) {
  //     //   // Check for special case of empty object, otherwise calculate based on end of keys
  //     //   size = Object.keys(currentObjectStored.object).length == 0 ? 5 : currentObjectStored.endIndex - currentObjectStored.index;        
  //     //   // Write the size of the string to buffer
  //     //   buffer[currentObjectStored.index + 3] = (size >> 24) & 0xff;     
  //     //   buffer[currentObjectStored.index + 2] = (size >> 16) & 0xff;
  //     //   buffer[currentObjectStored.index + 1] = (size >> 8) & 0xff;
  ...
  //     done = true;
  //   // } else if(finished || keys.length == 0){
  //   //   // Add terminating 0 and update index
  //   //   buffer[index++] = 0;
  //   //   // Pop the last option
  //   //   currentObjectStored = stack.pop();
  //   //   currentObject = currentObjectStored.object;      
  //   //   codeStartIndex = currentObjectStored.codeStartIndex;
  //   // 
  //   //   // For Code Objects
  //   //   if(codeStartIndex) {
  //   //     // Calculate code object size
  //   //     size = index - codeStartIndex;                                    
  //   //     // Write the size of the string to buffer
  //   //     buffer[codeStartIndex + 3] = (size >> 24) & 0xff;     
  //   //     buffer[codeStartIndex + 2] = (size >> 16) & 0xff;
  //   //     buffer[codeStartIndex + 1] = (size >> 8) & 0xff;
  //   //     buffer[codeStartIndex] = size & 0xff;                
  //   //     
  //   //     // Reset the code start index
  //   //     codeStartIndex = 0;
  //   //   }
  //   // 
  //   //   keys = currentObjectStored.keys;
  //   //   // Set currentObjectStored end index
  //   //   currentObjectStored.endIndex = index; 
  //   //   // debug(inspect(keys))
  //   //   finished = keys.length == 0 ? true: false;
  //   }
...
BSON.serialize = function serialize(object, checkKeys, asBuffer) {
  ...
  if(object instanceof Object) {
    ...
    // debug("========= calculatedSize = " + calculatedSize)
    ...
    // var index = 0;
    // var finalBuffer = require('../../mongodb').native().BSON.serialize(object, checkKeys, asBuffer);    
    // 
    // // var c = require('../../mongodb').native();
    // // // var d = { b: [ 1, 2, 3 ], _id: new c.ObjectID.createFromHexString(object._id.toHexString()) };
    // // var d = { b: [ 1, 2, 3 ], _id: new c.ObjectID.createFromHexString(object._id.toHexString()) };
    // // var finalBuffer = require('../../mongodb').native().BSON.serialize(d, checkKeys, asBuffer);    
    // // var finalBuffer = require('../../mongodb').native().BSON.serialize(object, checkKeys, asBuffer);    
    // // 
    // // 
    // // debug("--------------------------------------------------------- compare")
    ...
    //   debug("[" + i + "] :: " + buffer.toString('ascii', i, i+1) + " :: [" + buffer[i] + "]" + " = [" + finalBuffer[i] + "] :: " + finalBuffer.toString('ascii', i, i+1))      
    //   // require('assert').equal(buffer[i], finalBuffer[i])      
    // }
    // 
    // // debug("--------------------------------------------------------- finalBuffer")
...
BSON.encodeValue = function(buffers, elementName, value, checkKeys) {
  ...
  if(value == null) {
    ...
    // debug("========== array :: " + elementName + ":" + (objectLength - o))
  } else if(value instanceof Date || toString.call(value) === '[object Date]') {
...
// BSON.serialize = function(data) {
//   return require('../../mongodb').native().BSON.serialize(data);  
// }
...
BSON.deserialize = function(data, is_array_item, returnData, returnArray) {
  ...
  //   // debug("------")
  //   debug(data[j] + " :: " + data.toString('ascii', j, j + 1))
  // }
  
  return require('../../mongodb').native().BSON.deserialize(data);  
}
...
//   
//   // Decode 
//   var size = binaryutils.decodeUInt32(data, index);
//   // Ajust index
//   index = index + 4;
//   
...
//       // debug("========================================================== current")
//       // debug(inspect(currentObjectInstance))
// 
//       // debug("  -------------------------------------------------------- value")
//       // debug(inspect(value))
//       
...
//         // currentObject[parseInt(currentObjectInstance.name, 10)] = value;
//       // } else {
