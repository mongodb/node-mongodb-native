...
BSON.deserialize = function(data, is_array_item, returnData, returnArray) {
  ...
  // sys.puts("=================== bSON size: " + size)
  // sys.debug("======================================================== DATA START")
  // BinaryParser.hprint(data.substr(index, size))
  // sys.debug("======================================================== DATA END")
  ...
  while(index < data.length) {
    ...
    if(type == BSON.BSON_DATA_STRING) {
      ...
      // 
      // sys.debug("======================== index: " + index)
      // sys.debug("======================== string_end_index: " + string_end_index)
      ...
      // sys.debug("======================== string_size: " + string_size)
      ...
      // sys.debug("================================= index: " + index)
      // BinaryParser.pprint(data.substr(index, 4))
      ...
      sys.debug("============================ oid: " + sys.inspect(oid))
      BinaryParser.hprint(oid);
...
BSON.encodeValue = function(encoded_string, variable, value, top_level, checkKeys) {
  ...
  } else if(value instanceof Long || value instanceof Long2) {
    sys.debug("======================================= ENCODE LONG");
