  ...
  while(index < data.length) {
    ...
    switch (type) {
      case BSON.BSON_DATA_STRING:
        ...
        if(is_array_item) {
          insert_index = parseInt(string_name, 10);
        }
        ...
        // TODO
        if (is_array_item) {
          return_array[insert_index] = value;
        } else {
      ...
      case BSON.BSON_DATA_NULL:
        ...
        // TODO
        if (is_array_item) {
          return_array[insert_index] = null;
        } else {
      ...
      case BSON.BSON_DATA_TIMESTAMP:
        ...
        // Create to integers
        var value = type === BSON.BSON_DATA_TIMESTAMP
          ? new Timestamp(low_bits, high_bits)
          : new Long(low_bits, high_bits);
