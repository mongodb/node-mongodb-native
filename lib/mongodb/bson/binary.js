 ...
 * 
 * Sub types
 *  - **SUBTYPE_DEFAULT**, default BSON type.
 *  - **SUBTYPE_FUNCTION**, BSON function type.
 *  - **SUBTYPE_BYTE_ARRAY**, BSON byte array type.
 *  - **SUBTYPE_UUID**, BSON uuid type.
 *  - **SUBTYPE_MD5**, BSON md5 type.
 *  - **SUBTYPE_USER_DEFINED**, BSON user defined type.
 *
