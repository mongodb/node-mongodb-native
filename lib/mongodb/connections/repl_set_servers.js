...
ReplSetServers.prototype.checkoutWriter = function() {
  ...
  // console.dir(this._state.master.checkoutWriter())  
  // console.dir(this._state.master.connection)
  return this._state.master.checkoutWriter();
}

ReplSetServers.prototype.checkoutReader = function() {
  console.log("================================================================ checkoutReader")
  console.log("this.readSecondary :: " + this.readSecondary)
  ...
  if(this.readSecondary == true && Object.keys(this._state.secondaries).length > 0) {
    ...
    // console.dir(this._state.secondaries[key])
    return this._state.secondaries[key].checkoutReader();
    // var server = this._state.secondaries[Math.floor(Math.random() * this.secondaries.length)];
