...
var createChangeNotificationCursor = function (serverTopology, databaseName, collectionName, pipeline) {
  ...
  var oplogCursor = oplogCollection.find(query, {
    ...
    oplogDocument = translateFromOplogToChangeNotification(oplogDocument)
    aggregationProcessorCollection.insert(oplogDocument).then(function () {
  ...
  setInterval(function() {
    oplogCursor.hasNext(function (err, hasNext) {
      if (hasNext) {
        oplogCursor.next()
      }
    })
