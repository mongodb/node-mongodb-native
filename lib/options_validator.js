...
function validate(
  ...
  Object.keys(optionsSchema).forEach(optionName => {
    ...
    if (optionDefaults && optionDefaults.hasOwnProperty(optionName)) {
      if (optionDefaults[optionName] == null) {
        throw new Error(`A dynamic default of null or undefined was provided for [${optionName}].`);
      }
    ...
    if (
      overrideOptions &&
      overrideOptions.hasOwnProperty(optionName) &&
      overrideOptions[optionName] != null
    ) {
