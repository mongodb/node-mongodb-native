 ...
 * @param {boolean} [options.useNewUrlParser=false] Determines whether or not to use the new url parser. If true, the new url parser will be used to verify the connection string, which will help ensure that connection strings work with the new url parsing. In the future, this option will be removed and the new url parser will always be used.
