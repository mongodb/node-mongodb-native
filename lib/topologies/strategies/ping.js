...
var Ping = function(options) {
  ...
  this.pickServer = function(set, readPreference) {
    ...
    // var names = serverList.map(function(x) { return x.name; })
    // console.dir(names)
    ...
    serverList = serverList.filter(function(s) {
      // console.dir("===================== " + s.time + ' < ' + (lowest + acceptableLatency));
    ...
    // console.log("==================================== ELIGABLE SERVERS")
    // console.dir(serverList.length)
    // console.dir(index)
    // var names = serverList.map(function(x) { return x.name; })
    // console.dir(names)
    // console.dir(set.get(serverList[index].name))
