...
var Callbacks = function() {
  ...
  Object.defineProperty(this, 'id', {
    enumerable:true, get: function() { return self.id; }
  });
...
var Server = function(options) {
  ...
  this.connect = function(_options) {
    ...
    if(!s.pool) {
      s.options.messageHandler = messageHandler;
      s.pool = new Pool(s.options);      
    }
  ...
  this.command = function(ns, cmd, options, callback) {
    ...
    if(!self.isConnected() && s.disconnectHandler != null) {
      ...
      return s.disconnectHandler.add('command', ns, cmd, options, callback);
    }
  ...
  this.insert = function(ns, ops, options, callback) {
    ...
    if(!self.isConnected() && s.disconnectHandler != null) {
      callback = bindToCurrentDomain(callback);
      return s.disconnectHandler.add('insert', ns, ops, options, callback);
    }
  ...
  this.update = function(ns, ops, options, callback) {
    ...
    if(!self.isConnected() && s.disconnectHandler != null) {
      callback = bindToCurrentDomain(callback);
      return s.disconnectHandler.add('update', ns, ops, options, callback);
    }
  ...
  this.remove = function(ns, ops, options, callback) {
    ...
    if(!self.isConnected() && s.disconnectHandler != null) {
      callback = bindToCurrentDomain(callback);
      return s.disconnectHandler.add('remove', ns, ops, options, callback);
    }
