...
ReplSetState.prototype.update = function(server) {
  ...
  if(!this.primary && ismaster.ismaster && ismaster.setName) {
    ...
    if(!this.maxElectionId && ismasterElectionId) {
      ...
      // console.log("===== ismasterElectionId 0")
      // console.log(" ismasterElectionId = " + ismasterElectionId.toString())
      // console.log(" this.maxElectionId = " + this.maxElectionId.toString())

      var result = compareObjectIds(this.maxElectionId, ismasterElectionId);

      if(result == 1) {
        // console.log("==== ismasterElectionId 0:0")
        return false;
      } else if(result == 0 && currentSetVersion && ismasterSetVersion) {
        // console.log("==== ismasterElectionId 0:1")
        if(ismasterSetVersion < this.maxSetVersion) {
          return false;
        }
      } else {
        // console.log("==== ismasterElectionId 0:2")
        // console.log("ismasterSetVersion :: " + ismasterSetVersion)
        // console.log("this.maxSetVersion :: " + this.maxSetVersion)

        if(ismasterSetVersion < this.maxSetVersion) {
          return false;
        }

        // console.log("==== ismasterElectionId 0:3")
      }
    ...
    //
    // console.log("===== ismasterElectionId 1 :: " + server.name)
