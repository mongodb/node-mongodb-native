  ...
  return function() {
    ...
    waitForAuth(function() {
      ...
      while(true) {
        ...
        // console.log(`connections.length ${connections.length} of ${self.availableConnections.length}`)
