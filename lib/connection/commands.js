...
var Response = function(bson, data, opts) {
  ...
  //     var bsonSize = data.readUInt32LE(this.index);
  //     // Parse options
  //     var _options = {promoteLongs: opts.promoteLongs};

  //     // If we have raw results specified slice the return document
  //     if(raw) {
  //       this.documents.push(data.slice(this.index, this.index + bsonSize));
  //     } else {
  //       this.documents.push(bson.deserialize(data.slice(this.index, this.index + bsonSize), _options));
  //     }
