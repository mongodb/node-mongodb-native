...
/** @typedef {'minWireVersion' | 'maxWireVersion' | 'maxBsonObjectSize' | 'maxMessageSizeBytes' | 'maxWriteBatchSize' | 'compression' | 'me' | 'hosts' | 'passives' | 'arbiters' | 'tags' | 'setName' | 'setVersion' | 'electionId' | 'primary' | 'logicalSessionTimeoutMinutes' | 'saslSupportedMechs' | '__nodejs_mock_server__' | '$clusterTime'} IsMasterProperties */
...
class ServerDescription {
   ...
   * @param {Error} [options.error] The round trip time to ping this server (in ms)
   */
  constructor(address, ismaster, options) {
    ...
    // https://github.com/mongodb/specifications/blob/master/source/server-discovery-and-monitoring/server-discovery-and-monitoring.rst#serverdescription
    // set up defaults / required properties
    ...
    this.minWireVersion = null;
    this.maxWireVersion = null;
    this.me = null;
    /** @type {string[]} */
    this.hosts = [];
    /** @type {string[]} */
