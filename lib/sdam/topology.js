...
class Topology extends EventEmitter {
   ...
   * @param {any} [options.cursorFactory] TODO:(neal) types and documentation
   * @param {any} [options.reconnect] TODO:(neal) types and documentation
   * @param {any} [options.emitError] TODO:(neal) types and documentation
   * @param {any} [options.maxPoolSize] TODO:(neal) types and documentation
   * @param {any} [options.minPoolSize] TODO:(neal) types and documentation
   * @param {any} [options.monitorCommands] TODO:(neal) types and documentation
   */
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session=null] Session to use for the operation
   * @param {boolean} [options.noResponse] TODO:(neal) documentation
   * @param {number} [options.serverSelectionTimeoutMS] TODO:(neal) documentation
   * @param {boolean} [options.retrying] TODO:(neal) documentation
   * @param {any} [options.retryWrites] TODO:(neal) documentation & type
   * @param {(error?: Error, result?: any) => void} callback A callback function
   */
