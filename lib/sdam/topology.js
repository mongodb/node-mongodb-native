...
class Topology extends EventEmitter {
   ...
   * @param {any} [options.cursorFactory] TODO:(ts) types and documentation
   * @param {any} [options.reconnect] TODO:(ts) types and documentation
   * @param {any} [options.emitError] TODO:(ts) types and documentation
   * @param {any} [options.maxPoolSize] TODO:(ts) types and documentation
   * @param {any} [options.minPoolSize] TODO:(ts) types and documentation
   * @param {any} [options.monitorCommands] TODO:(ts) types and documentation
   * @param {any} [options.replicaSet] TODO:(ts) types and documentation
   * @param {any} [options.minHeartbeatFrequencyMS] TODO:(ts) types and documentation
   * @param {any} [options.credentials] TODO:(ts) types and documentation
   * @param {any} [options.promiseLibrary] TODO:(ts) types and documentation
   * @param {any} [options.srvHost] TODO:(ts) types and documentation
   * @param {any} [options.srvPoller] TODO:(ts) types and documentation
   * @param {any} [options.logger] TODO:(ts) types and documentation
   * @param {any} [options.loggerLevel] TODO:(ts) types and documentation
   * @param {any} [options.metadata] TODO:(ts) types and documentation
   */
   ...
   * @param {any} [options.readPreference] TODO:(ts) documentation
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session=null] Session to use for the operation
   * @param {boolean} [options.noResponse] TODO:(ts) documentation
   * @param {number} [options.serverSelectionTimeoutMS] TODO:(ts) documentation
   * @param {boolean} [options.retrying] TODO:(ts) documentation
   * @param {any} [options.retryWrites] TODO:(ts) documentation & type
   * @param {boolean} [options.willRetryWrite] TODO:(ts) documentation & type
   * @param {(error?: Error, result?: any) => void} callback A callback function
   */
 ...
 *
 * @param {Topology} topology TODO:(ts) Mongos|Replset types
 */
