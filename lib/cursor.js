...
class Cursor extends CoreCursor {
   ...
   * @method
   * @param {(string|ReadConcern)} readConcern The new read preference for the cursor.
   * @throws {MongoError}
   * @return {Cursor}
   */
  withReadConcern(readConcern) {
    ...
    this.options.readConcern = ReadConcern.fromLike(readConcern);
    return this;
  }
  ...
  withReadPreference(readPreference) {
    ...
    this.options.readPreference = ReadPreference.fromLike(readPreference);
    return this;
  }
...
Cursor.prototype.setReadPreference = deprecate(
  Cursor.prototype.withReadPreference,
  'Cursor method .setReadPreference has been deprecated and will be removed in later versions of the driver, please use .withReadPreference'
);
