...
Cursor.prototype.hasNext = function(callback) {
  ...
  return executeOperationV2(this.s.topology, hasNextOperation, callback);
};
...
Cursor.prototype.next = function(callback) {
  ...
  return executeOperationV2(this.s.topology, nextOperation, callback);
};
...
Cursor.prototype.toArray = function(callback) {
  ...
  return executeOperationV2(this.s.topology, toArrayOperation, callback);
};
...
Cursor.prototype.count = function(applySkipLimit, opts, callback) {
  ...
  return executeOperationV2(this.s.topology, countOperation, callback);
};
...
Cursor.prototype.explain = function(callback) {
  ...
  return executeOperationV2(this.s.topology, explainOperation, callback);
};
