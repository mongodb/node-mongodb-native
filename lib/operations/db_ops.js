 ...
 */
const evaluate = deprecate(function(db, code, parameters, options, callback) {
  let finalCode = code;
  let finalParameters = [];
 ...
 */
const profilingInfo = deprecate(function(db, options, callback) {
  try {
    db
...
}, 'db.profilingInfo is deprecated and will be removed in a later version. Query the system.profile collection directly.');
