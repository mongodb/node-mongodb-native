...
function createIndex(self, name, fieldOrSpec, options, callback) {
...
function createIndexUsingCreateIndexes(self, name, fieldOrSpec, options, callback) {
  // Build the index
...
function ensureIndex(self, name, fieldOrSpec, options, callback) {
  // Get the write concern options
  ...
  indexInformation(self, name, finalOptions, function(err, indexInformation) {
    if (err != null && err.code !== 26) return handleCallback(callback, err, null);
    // If the index does not exist, create it
    if (indexInformation == null || !indexInformation[index_name]) {
      createIndex(self, name, fieldOrSpec, options, callback);
    } else {
...
function indexInformation(self, name, options, callback) {
