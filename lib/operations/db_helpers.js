...
const profilingInfo = function(self, options, callback) {
  try {
    self
...
const profilingLevel = function(self, options, callback) {
...
const setProfilingLevel = function(self, level, options, callback) {
  var command = {};
  var profile = 0;
