...
function findAndModify(coll, query, sort, doc, options, callback) {
  ...
  queryObject.new = options.new;
  queryObject.remove = options.remove;
  queryObject.upsert = options.upsert;
...
function findOneAndDelete(coll, filter, options, callback) {
  ...
  findAndModify(coll, filter, options.sort, null, options, callback);
}
...
function findOneAndReplace(coll, filter, replacement, options, callback) {
  ...
  findAndModify(coll, filter, options.sort, replacement, options, callback);
}
...
function findOneAndUpdate(coll, filter, update, options, callback) {
  // Execute findAndModify
  findAndModify(coll, filter, options.sort, update, options, callback);
}
...
function rename(coll, newName, options, callback) {
  ...
  const cmd = { renameCollection: renameCollection, to: toCollection, dropTarget };
