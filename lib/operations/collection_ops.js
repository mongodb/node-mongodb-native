...
const { insertDocuments, updateDocuments } = require('./common_functions');
const {
  applyWriteConcern,
...
const {
  createIndex: createIndexDb,
  ensureIndex: ensureIndexDb,
  evaluate,
  executeCommand,
  indexInformation: indexInformationDb
} = require('./db_ops');

// type imports
/** @typedef {import('../collection')} Collection */
/** @typedef {import('../collection').CollectionResultCallback} CollectionResultCallback */
/** @typedef {import('../collection').CollectionWriteOpCallback} CollectionWriteOpCallback */
/** @typedef {import('../collection').CollectionParallelCollectionScanCallback} CollectionParallelCollectionScanCallback */
