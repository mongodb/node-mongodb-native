...
class InsertOneModel extends BulkInsertModel {
  ...
  execute(server, callback) {
    return super.execute(server, (err, r) => insertOneCallback(err, r, this.operations, callback));
  }
}
...
class UpdateModel extends BulkUpdateModel {
  ...
  execute(server, callback) {
    return super.execute(server, (err, r) => updateCallback(err, r, callback));
  }
}
...
class RemoveModel extends BulkRemoveModel {
  ...
  execute(server, callback) {
    return super.execute(server, (err, r) => deleteCallback(err, r, callback));
  }
}
