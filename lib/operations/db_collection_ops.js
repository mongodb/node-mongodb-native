...
function createCollection(self, name, options, callback) {
  ...
  self
    ...
    .toArray(function(err, collections) {
      ...
      // Execute command
      executeCommand(self, cmd, finalOptions, function(err) {
...
function dropCollection(self, cmd, options, callback) {
  return executeCommand(self, cmd, options, function(err, result) {
    // Did the user destroy the topology
    if (self.serverConfig && self.serverConfig.isDestroyed()) {
      return callback(new MongoError('topology was destroyed'));
    }
