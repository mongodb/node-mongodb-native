...
function createMonitoringStream(fileName) {
  ...
  // if the file already exists, append a line with a timestamp to indicate that the
  // log output below it is from a different invocation
  if (fs.existsSync(fileName)) {
    const timestamp = new Date().toISOString();
    stream.write(`\nlog beginning at ${timestamp}\n\n`);
  }
