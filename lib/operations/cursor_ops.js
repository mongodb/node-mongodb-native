...
const { buildCountCommand } = require('./collection_ops');
...
/** @typedef {import('../cursor/cursor').CursorToArrayResultCallback} CursorToArrayResultCallback */
/** @typedef {import('../cursor/cursor').CursorCountResultCallback} CursorCountResultCallback */
/** @typedef {import('../cursor/cursor').CursorResultCallback} CursorResultCallback */
 ...
 * @param {object} [opts] Optional settings. See Cursor.prototype.count for a list of options.
