...
class MongoError extends Error {
  /**
   * @param {string | object | Error} message The error message
   */
  constructor(message) {
   ...
   *
   * @param {string | object | Error} options The options used to create the error.
 ...
 *
 * @param {string | object | Error} message The error message
 * @param {string|object} [reason] The reason the timeout occurred
 * @property {string} message The error message
...
/**
 * @param {(MongoError|Error) & {code: number}} error the error returned by mongodb
 */
 ...
 *
 * @param {(MongoError|Error) & {code: number}} error
 */
