...
// type imports
/** @typedef {InstanceType<import('./mongo_credentials')['MongoCredentials']>} MongoCredentials */
...
class AuthProvider {
   ...
   *
   * @param {any} _sendAuthCommand
   * @param {any} _connection
   * @param {any} _credentials
   * @param {any} _callback
   */
  _authenticateSingleConnection(_sendAuthCommand, _connection, _credentials, _callback) {
 ...
 * @param {MongoError} error An error object. Set to null if no error present
