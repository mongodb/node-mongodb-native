 ...
 * @property {any} [autoEncrypter] Options for client side encryption TODO:(ts) get type in mongo_client.js
 * @property {any} [metadata] Metadata for a connection pool.
 * @property {number} [minSize] TODO:(ts) documentation
 * @property {number} [maxSize] TODO:(ts) documentation
 */
...
class ConnectionPool extends EventEmitter {
   ...
   *
   * @param {ConnectionPoolCheckOutCallback} callback
   */
  checkOut(callback) {
   ...
   *
   * @param {ConnectionPoolWithConnectionCallback} fn A function which operates on a managed connection
 ...
 *
 * @callback ConnectionPoolWithConnectionCallback
 ...
 *
 * @callback ConnectionPoolCheckOutCallback
