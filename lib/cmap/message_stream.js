...
const { Response } = require('../core/connection/commands');
const { Msg, BinMsg } = require('../core/connection/msg');
const { MongoError, MongoParseError } = require('../error');
const {
  MESSAGE_HEADER_SIZE,
  COMPRESSION_DETAILS_SIZE,
  opcodes
} = require('../core/wireprotocol/shared');
const {
  compress,
  decompress,
  compressorIDs,
  uncompressibleCommands
} = require('../core/wireprotocol/compression');
const { OP_COMPRESSED, OP_MSG } = opcodes;
