...
Object.defineProperty(Collection.prototype, 'writeConcern', {
  ...
  get: function() {
    const writeConcern = new WriteConcern(
      this.s.options.w,
      this.s.options.wtimeout,
      this.s.options.j,
      this.s.options.fsync
    );
    if (writeConcern.isDefined()) {
      return writeConcern;
    }
    return null;
  }
...
Collection.prototype.indexInformation = function(options, callback) {
  ...
  const indexInformationOperation = new IndexInformationOperation(this.s.db, this.s.name, options);
