...
Collection.prototype.find = deprecateOptions(
  ...
  function(query, options, callback) {
    ...
    const findSchema = {
      ...
      hint: { type: ['string', 'object'], default: this.s.collectionHint },
      ...
      comment: { type: 'string' },
      raw: { type: 'boolean', default: this.s.raw },
      promoteLongs: { type: 'boolean', default: this.s.promoteLongs },
      promoteValues: { type: 'boolean', default: this.s.promoteValues },
      promoteBuffers: { type: 'boolean', default: this.s.promoteBuffers },
      readPreference: { type: [ReadPreference, 'object', 'string'] },
      partial: { type: 'boolean' },
      maxTimeMS: { type: 'number' },
      collation: { type: 'object' },
      session: { type: ClientSession },
      promiseLibrary: { rejectUser: true },
      slaveOk: { type: 'boolean', default: this.s.db.slaveOk },
      awaitData: { rejectUser: true },
      noCursorTimeout: { type: 'boolean', rejectUser: true },
      ignoreUndefined: { rejectUser: true }
    };
    ...
    const finalOptions = validate(
      ...
      options,
      {
        ...
        awaitData: options ? options.awaitdata : null,
    ...
    for (let name in finalOptions) {
      if (finalOptions[name] != null && name !== 'session') {
        findCommand[name] = finalOptions[name];
      }
    }
...
Collection.prototype.insertOne = function(doc, options, callback) {
  ...
  const insertOneSchema = {
    ...
    session: { type: ClientSession },
    ignoreUndefined: { type: 'boolean', rejectUser: true }
  };
  ...
  return executeOperation(this.s.topology, insertOne, [this, doc, finalOptions, callback]);
};
...
Collection.prototype.insertMany = function(docs, options, callback) {
  ...
  const insertManySchema = {
    ...
    wtimeout: { type: 'number' },
    j: { type: 'boolean' },
    serializeFunctions: { type: 'boolean', default: this.s.serializeFunctions },
    bypassDocumentValidation: { type: 'boolean' },
  ...
  docs = prepareDocs(this, docs, finalOptions);
  ...
  return executeOperation(this.s.topology, bulkWrite, [this, operations, finalOptions, callback], {
...
Collection.prototype.updateOne = function(filter, update, options, callback) {
  ...
  const updateOneSchema = {
    ...
    j: { type: 'boolean' },
    bypassDocumentValidation: { type: 'boolean' },
    arrayFilters: { type: 'object' },
    collation: { type: 'object' },
    ignoreUndefined: { type: 'boolean', rejectUser: true },
    session: { type: ClientSession },
    multi: { rejectUser: true }
  };

  const finalOptions = validate(
    updateOneSchema,
    options,
    { ignoreUndefined: this.s.options.ignoreUndefined, multi: false },
    { validationLevel: 'error' }
  );
...
Collection.prototype.replaceOne = function(filter, doc, options, callback) {
  ...
  return executeOperation(this.s.topology, replaceOne, [this, filter, doc, finalOptions, callback]);
};
...
Collection.prototype.updateMany = function(filter, update, options, callback) {
  ...
  const finalOptions = validate(
    updateManySchema,
    options,
    { ignoreUndefined: this.s.options.ignoreUndefined, multi: true },
    { validationLevel: 'error' }
  );
...
Collection.prototype.deleteOne = function(filter, options, callback) {
  ...
  const deleteOneSchema = {
    ...
    session: { type: ClientSession },
    ignoreUndefined: { type: 'boolean', rejectUser: true },
    single: { rejectUser: true }
  };

  const finalOptions = validate(
    deleteOneSchema,
    options,
    { ignoreUndefined: this.s.options.ignoreUndefined, single: true },
    { validationLevel: 'error' }
  );

  return executeOperation(this.s.topology, deleteOne, [this, filter, finalOptions, callback]);
};
...
Collection.prototype.deleteMany = function(filter, options, callback) {
  ...
  const finalOptions = validate(
    deleteManySchema,
    options,
    { ignoreUndefined: this.s.options.ignoreUndefined, single: false },
    { validationLevel: 'error' }
  );

  return executeOperation(this.s.topology, deleteMany, [this, filter, finalOptions, callback]);
};
...
Collection.prototype.findOne = deprecateOptions(
  ...
  function(query, options, callback) {
    ...
    const finalOptions = validate(findOneSchema, options, { validationLevel: 'error' });

    return executeOperation(this.s.topology, findOne, [this, query, finalOptions, callback]);
  }
);
...
Collection.prototype.rename = function(newName, options, callback) {
  ...
  const renameSchema = {
    ...
    readPreference: { type: [ReadPreference, 'string', 'object'], rejectUser: true },
    session: { type: ClientSession }
  };
  ...
  return executeOperation(this.s.topology, rename, [this, newName, finalOptions, callback]);
};
...
Collection.prototype.options = function(opts, callback) {
  ...
  const finalOpts = validate(optionsSchema, opts, { validationLevel: 'error' });
...
Collection.prototype.isCapped = function(options, callback) {
  ...
  const finalOptions = validate(isCappedSchema, options, { validationLevel: 'error' });

  return executeOperation(this.s.topology, isCapped, [this, finalOptions, callback]);
};
...
Collection.prototype.createIndex = function(fieldOrSpec, options, callback) {
  ...
  const finalOptions = validate(createIndexSchema, options, { validationLevel: 'error' });
...
Collection.prototype.createIndexes = function(indexSpecs, options, callback) {
  ...
  const createIndexesSchema = {
    ...
    j: { type: 'boolean' },
    maxTimeMS: { type: 'number' },
    readPreference: { rejectUser: true },
    session: { type: ClientSession }
  };
...
Collection.prototype.dropIndex = function(indexName, options, callback) {
  ...
  return executeOperation(this.s.topology, dropIndex, [this, indexName, finalOptions, callback]);
};
...
Collection.prototype.dropIndexes = function(options, callback) {
  ...
  const finalOptions = validate(dropIndexesSchema, options, { validationLevel: 'error' });

  return executeOperation(this.s.topology, dropIndexes, [this, finalOptions, callback]);
};
...
Collection.prototype.reIndex = function(options, callback) {
  ...
  const finalOptions = validate(reIndexSchema, options, { validationLevel: 'error' });

  return executeOperation(this.s.topology, reIndex, [this, finalOptions, callback]);
};
...
Collection.prototype.listIndexes = function(options) {
  ...
  const listIndexesSchema = {
    ...
    readPreference: { type: [ReadPreference, 'object', 'string'] },
    session: { type: ClientSession },
    cursorFactory: { type: 'function', rejectUser: true },
    promiseLibrary: { rejectUser: true }
  };
  ...
  // Cursor options
  let cursor = finalOptions.batchSize ? { batchSize: finalOptions.batchSize } : {};
  ...
  if (this.s.topology.capabilities().hasListIndexesCommand) {
    ...
    // Execute the cursor
    cursor = this.s.topology.cursor(`${this.s.dbName}.$cmd`, command, finalOptions);
    // Do we have a readPreference, apply it
    if (finalOptions.readPreference) cursor.setReadPreference(finalOptions.readPreference);
    // Return the cursor
    return cursor;
  }
  ...
  // Get the query
  cursor = this.s.topology.cursor(ns, { find: ns, query: { ns: this.s.namespace } }, finalOptions);
  // Do we have a readPreference, apply it
  if (finalOptions.readPreference) cursor.setReadPreference(finalOptions.readPreference);
  // Set the passed in batch size if one was provided
  if (finalOptions.batchSize) cursor = cursor.batchSize(finalOptions.batchSize);
  // Return the cursor
  return cursor;
};
...
Collection.prototype.indexExists = function(indexes, options, callback) {
  ...
  const finalOptions = validate(indexExistsSchema, options, { validationLevel: 'error' });

  return executeOperation(this.s.topology, indexExists, [this, indexes, finalOptions, callback]);
};
...
Collection.prototype.indexInformation = function(options, callback) {
  ...
  const finalOptions = validate(indexInformationSchema, options, { validationLevel: 'error' });

  return executeOperation(this.s.topology, indexInformation, [this, finalOptions, callback]);
};
...
Collection.prototype.estimatedDocumentCount = function(options, callback) {
  ...
  const finalOptions = validate(estimatedDocumentCountSchema, options, {
    validationLevel: 'error'
  });

  return executeOperation(this.s.topology, count, [this, null, finalOptions, callback]);
};
...
Collection.prototype.countDocuments = function(query, options, callback) {
  ...
  const finalOptions = validate(countDocumentsSchema, options, { validationLevel: 'error' });

  return executeOperation(this.s.topology, countDocuments, [this, query, finalOptions, callback]);
};
...
Collection.prototype.indexes = function(options, callback) {
  ...
  return executeOperation(this.s.topology, indexes, [this, finalOptions, callback]);
};
...
Collection.prototype.stats = function(options, callback) {
  ...
  return executeOperation(this.s.topology, stats, [this, finalOptions, callback]);
};
...
Collection.prototype.findOneAndDelete = function(filter, options, callback) {
  ...
  const findOneAndDeleteSchema = {
    ...
    maxTimeMS: { type: 'number' },
    session: { type: ClientSession },
    fields: { rejectUser: true },
    remove: { rejectUser: true }
  };
...
Collection.prototype.aggregate = function(pipeline, options, callback) {
  ...
  const aggregateSchema = {
    ...
    session: { type: ClientSession },
    promiseLibrary: { type: 'function', rejectUser: true },
    cursorFactory: { rejectUser: true }
  };
  ...
  if (typeof finalOptions.out === 'string') {
  ...
  if (
    ...
    applyWriteConcern(command, { db: this.s.db, collection: this }, finalOptions);
  }
  ...
  if (finalOptions.bypassDocumentValidation === true) {
    command.bypassDocumentValidation = finalOptions.bypassDocumentValidation;
  }

  // Do we have a readConcern specified
  if (!ignoreReadConcern) {
    decorateWithReadConcern(command, this, finalOptions);
  }

  // If we have allowDiskUse defined
  if (finalOptions.allowDiskUse) command.allowDiskUse = finalOptions.allowDiskUse;
  if (typeof finalOptions.maxTimeMS === 'number') command.maxTimeMS = finalOptions.maxTimeMS;

  // If we are giving a hint
  if (finalOptions.hint) command.hint = finalOptions.hint;

  // If explain has been specified add it
  if (finalOptions.explain) {
    ...
    command.explain = finalOptions.explain;
  }

  if (typeof finalOptions.comment === 'string') command.comment = finalOptions.comment;

  command.cursor = finalOptions.cursor;
  if (finalOptions.batchSize) command.cursor.batchSize = finalOptions.batchSize;
  ...
  if (typeof callback !== 'function') {
    ...
    if (typeof finalOptions.allowDiskUse === 'boolean') {
      command.allowDiskUse = finalOptions.allowDiskUse;
    }
    if (typeof finalOptions.maxTimeMS === 'number') command.maxTimeMS = finalOptions.maxTimeMS;

    // Execute the cursor
    return this.s.topology.cursor(this.s.namespace, command, finalOptions);
  }

  return handleCallback(
    callback,
    null,
    this.s.topology.cursor(this.s.namespace, command, finalOptions)
  );
};
...
Collection.prototype.watch = function(pipeline, options) {
  ...
  return new ChangeStream(this, pipeline, finalOptions);
};
...
Collection.prototype.parallelCollectionScan = function(options, callback) {
  ...
  return executeOperation(this.s.topology, parallelCollectionScan, [this, finalOptions, callback], {
    skipSessions: true
  });
};
...
Collection.prototype.geoHaystackSearch = function(x, y, options, callback) {
  ...
  return executeOperation(this.s.topology, geoHaystackSearch, [this, x, y, finalOptions, callback]);
};
...
Collection.prototype.mapReduce = function(map, reduce, options, callback) {
  ...
  return executeOperation(this.s.topology, mapReduce, [this, map, reduce, finalOptions, callback]);
};
...
Collection.prototype.initializeUnorderedBulkOp = function(options) {
  ...
  return unordered(this.s.topology, this, finalOptions);
};
...
Collection.prototype.initializeOrderedBulkOp = function(options) {
  ...
  return ordered(this.s.topology, this, finalOptions);
};
