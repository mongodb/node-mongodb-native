 ...
 * @param {boolean} [options.raw] Return document results as raw BSON buffers.
 ...
 * @param {boolean} [options.serializeFunctions] Serialize functions on any object.
 * @param {boolean} [options.forceServerObjectId] Force server to assign _id values instead of driver.
 ...
 * @param {boolean} [options.raw] Return all BSON documents as Raw Buffer documents.
