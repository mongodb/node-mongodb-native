...
const decorateWithReadConcern = require('./operations/collection_ops').decorateWithReadConcern;
...
const options = require('./operations/collection_ops').options;
 ...
 */
const Collection = function(db, topology, dbName, name, pkFactory, options) {
...
var rename = function(coll, newName, options, callback) {
