...
const FindAndModifyOperation = findAndModifyModule.FindAndModifyOperation;
const FindOneAndDeleteModel = findAndModifyModule.FindOneAndDeleteModel;
const FindOneAndUpdateModel = findAndModifyModule.FindOneAndUpdateModel;
...
Collection.prototype.findOneAndDelete = function(filter, options, callback) {
  ...
  const model = new FindOneAndDeleteModel({
    collection: this,
    query: filter,
    options
  });
  const findOneAndDeleteOperation = new FindAndModifyOperation(model);
...
Collection.prototype.findOneAndReplace = function(filter, replacement, options, callback) {
  ...
  const model = new FindOneAndUpdateModel({
    collection: this,
    query: filter,
    doc: replacement,
    options
  ...
  const findOneAndReplaceOperation = new FindAndModifyOperation(model);
...
Collection.prototype.findOneAndUpdate = function(filter, update, options, callback) {
  ...
  const findOneAndUpdateOperation = new FindAndModifyOperation(model);
