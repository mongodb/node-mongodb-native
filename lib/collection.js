...
const createOptionsSchema = require('./options_validator').createOptionsSchema;
 ...
 */
const insertOneSchema = createOptionsSchema({
...
Collection.prototype.insertOne = function(doc, options, callback) {
  ...
  const finalOptions = insertOneSchema(options);
