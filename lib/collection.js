...
const AggregateOperation = require('./operations/aggregate_operation');
...
Collection.prototype.find = deprecateOptions(
  ...
  function(query, options, callback) {
    ...
    const findOperation = new FindOperation(this, selector, options);

    return findOperation.execute(callback);
  }
);
...
Collection.prototype.createIndex = function(fieldOrSpec, options, callback) {
  ...
  const createIndexOperation = new CreateIndexOperation(this, fieldOrSpec, options);
...
Collection.prototype.indexInformation = function(options, callback) {
  ...
  const indexInformationOperation = new IndexInformationOperation(this, options);
...
Collection.prototype.aggregate = function(pipeline, options, callback) {
  ...
  const aggregateOperation = new AggregateOperation(this.s.db, this, pipeline, options);

  return aggregateOperation.execute(callback);
};
