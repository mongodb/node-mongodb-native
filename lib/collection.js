...
class Collection {
   ...
   *
   * @function
   * @param {object[]} indexSpecs An array of index specifications to be created TODO:(neal) better type CollectionIndexDefinition
   * @param {object} [options] Optional settings
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionResultCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
  ...
  distinct(key, query, options, callback) {
    ...
    // TODO:(neal) types aren't smart enough
