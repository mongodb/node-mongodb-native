 ...
 * @property {Object} message TBD
 * @propert {Array} ops TBD
 */
 ...
 * @param {ClientSession} [options.session] optional session to use for this operation
 * @param {Collection~updateWriteOpCallback} [callback] The command result callback
 * @return {Promise} returns Promise resolving to {Collection~updateWriteOpResultObject} if no callback passed
 */
 ...
 * @return {Promise} returns Promise resolving to {Collection~findAndModifyWriteOpResultObject} if no callback passed
 */
