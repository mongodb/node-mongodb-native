...
Collection.prototype.rename = function(newName, opt, callback) {
  ...
  return executeOperation(this.s.topology, rename, [this, newName, opt, callback]);
};
...
Collection.prototype.count = function(query, options, callback) {
  ...
  return executeOperation(this.s.topology, count, [this, queryOption, optionsOption, callback]);
};
