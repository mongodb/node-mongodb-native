...
// type imports
/** @typedef {import('bson').Code} Code */
/** @typedef {import('bson').Timestamp} Timestamp */
/** @typedef {import('./logger')} Logger */
/** @typedef {InstanceType<import('./sessions')['ClientSession']>} ClientSession */
/** @typedef {InstanceType<import('./bulk/ordered')['OrderedBulkOperation']>} OrderedBulkOperation */
/** @typedef {InstanceType<import('./bulk/unordered')['UnorderedBulkOperation']>} UnorderedBulkOperation */
/** @typedef {InstanceType<import('./operations/operation')['OperationBase']>} OperationBase */

/**
 * @file The **Collection** class is an internal class that embodies a MongoDB collection
...
class Collection {
   ...
   * @param {CollectionInsertOneWriteOpCallback} [callback] The command result callback
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionInsertWriteOpCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
   */
  ...
  /**
   * @typedef {object} CollectionBulkWriteOpResult
   ...
   *
   * @callback CollectionBulkWriteOpCallback
   * @param {BulkWriteError} [error] An error instance representing the error during the execution.
   * @param {CollectionBulkWriteOpResult} [result] The result object if the command was executed successfully.
   */
  /**
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionBulkWriteOpCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
   */
  ...
  /**
   * @typedef {object} CollectionUpdateWriteOpResult
   ...
   * The callback format for inserts
   *
   * @callback CollectionUpdateWriteOpCallback
   * @param {MongoError} [error] An error instance representing the error during the execution.
   * @param {CollectionUpdateWriteOpResult} [result] The result object if the command was executed successfully.
   */
  /**
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionUpdateWriteOpCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
   */
   ...
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionUpdateWriteOpCallback} [callback] The command result callback
   * @returns {Promise<CollectionUpdateWriteOpResult>} returns Promise if no callback passed
   */
  ...
  /**
   * @typedef {object} CollectionDeleteWriteOpResult
   * @property {object} result The raw result returned from MongoDB. Will vary depending on server version.
   * @property {number} result.ok Is 1 if the command executed correctly.
   ...
   *
   * @callback CollectionDeleteWriteOpCallback
   * @param {MongoError} [error] An error instance representing the error during the execution.
   * @param {CollectionDeleteWriteOpResult} [result] The result object if the command was executed successfully.
   */
  /**
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionDeleteWriteOpCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
   */
   ...
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionResultCallback} [callback] The results callback
   * @returns {Promise} returns Promise if no callback passed
   */
   ...
   * @param {object} [options.collation] Specify collation (MongoDB 3.4 or higher) settings for update operation (see 3.4 documentation for available fields).
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionResultCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
   * @example
   ...
   *
   * @function
   * @param {object[]} indexSpecs An array of index specifications to be created TODO:(ts) better type CollectionIndexDefinition
   * @param {object} [options] Optional settings
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {number} [options.maxTimeMS] max time in milliseconds
   * @param {CollectionResultCallback} [callback] The command result callback
   * @returns {Promise} returns Promise if no callback passed
   * @example
   * const collection = client.db('foo').collection('bar');
   ...
   * @param {CollectionCountCallback} [callback] The command result callback.
   * @returns {Promise} returns Promise if no callback passed.
   */
  ...
  distinct(key, query, options, callback) {
    ...
    // TODO:(ts) types aren't smart enough
    const distinctOperation = /** @type {unknown} */ (new DistinctOperation(
      this,
      key,
      queryOption,
      optionsOption
    ...
    return executeOperation(
      this.s.topology,
      /** @type {OperationBase} */ (distinctOperation),
      callback
    );
  }
  /**
   ...
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionResultCallback} [callback] The collection result callback
   * @returns {Promise} returns Promise if no callback passed
   */
  ...
  /**
   * @typedef {object} CollectionFindAndModifyWriteOpResult
   ...
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session] optional session to use for this operation
   * @param {CollectionFindAndModifyCallback} [callback] The collection result callback
   * @returns {Promise<CollectionFindAndModifyWriteOpResult>} returns Promise if no callback passed
   */
   ...
   * @param {boolean} [options.serializeFunctions=false] Serialize functions on any object.
   * @param {boolean} [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
   * @param {ClientSession} [options.session] An optional session to use for this operation
   * @param {CollectionFindAndModifyCallback} [callback] The collection result callback
   * @returns {Promise<CollectionFindAndModifyWriteOpResult>} returns Promise if no callback passed
   */
...
/**
 * @typedef {object} CollectionWriteOpResult
 ...
 * The callback format for inserts
 *
 * @callback CollectionWriteOpCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 * @param {CollectionWriteOpResult} [result] The result object if the command was executed successfully.
 */

/**
 * @typedef {object} CollectionInsertWriteOpResult
...
/**
 * @typedef {object} CollectionInsertOneWriteOpResult
 * @property {number} insertedCount The total amount of documents inserted.
 * @property {object[]} ops All the documents inserted using insertOne/insertMany/replaceOne. Documents contain the _id field if forceServerObjectId == false for insertOne/insertMany
 ...
 * The callback format for inserts
 *
 * @callback CollectionInsertWriteOpCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 * @param {CollectionInsertWriteOpResult} [result] The result object if the command was executed successfully.
 */

/**
 * The callback format for inserts
 *
 * @callback CollectionInsertOneWriteOpCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 * @param {CollectionInsertOneWriteOpResult} [result] The result object if the command was executed successfully.
 */

/**
 * The callback format for inserts
 *
 * @callback CollectionFindAndModifyCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 * @param {CollectionFindAndModifyWriteOpResult} [result] The result object if the command was executed successfully.
 */
 ...
 * @param {ClientSession} [options.session] optional session to use for this operation
 * @param {object} [options.hint] An optional hint for query optimization. See the {@link https://docs.mongodb.com/manual/reference/command/update/#update-command-hint|update command} reference for more information.
 * @param {CollectionWriteOpCallback} [callback] The command result callback
 * @throws {MongoError}
 * @returns {Promise} returns Promise if no callback passed
 ...
 *
 * @callback CollectionCountCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 ...
 *
 * @callback CollectionResultCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 ...
 * @param {ClientSession} [options.session] optional session to use for this operation
 * @param {Array} [options.arrayFilters] optional list of array filters referenced in filtered positional operators
 * @param {CollectionFindAndModifyCallback} [callback] The command result callback
 * @returns {Promise} returns Promise if no callback passed
 ...
 * The callback format for results
 *
 * @callback CollectionParallelCollectionScanCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
 ...
 * @param {CollectionParallelCollectionScanCallback} [callback] The command result callback
 * @returns {Promise} returns Promise if no callback passed
 */
