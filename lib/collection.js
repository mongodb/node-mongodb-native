 ...
 * @method
 * @param {object} [options=null] Optional settings.
 * @param {number} [options.maxTimeMS=null] The maximum amount of time to allow the operation to run.
 * @param {Collection~countCallback} [callback] The command result callback.
 * @return {Promise} returns Promise if no callback passed.
 */
...
const count = function(self, query, options, callback) {
  ...
  // Add maxTimeMS, hint, skip, and limit if defined
 ...
 * @param {object} [query] the query for the count
 * @param {object} [options=null] Optional settings.
 * @param {object} [options.collation=null] Specifies a collation.
 * @param {string|object} [options.hint=null] The index to use.
 * @param {number} [options.limit=null] The maximum number of document to count.
 * @param {number} [options.maxTimeMS=null] The maximum amount of time to allow the operation to run.
 * @param {number} [options.skip=null] The number of documents to skip before counting.
 * @param {Collection~countCallback} [callback] The command result callback.
 * @return {Promise} returns Promise if no callback passed.
 */
...
const countDocuments = function(self, query, options, callback) {
  const skip = options.skip;
  const limit = options.limit;
  ...
  self.aggregate(pipeline, options, function(err, result) {
    if (err) return handleCallback(callback, err);
    result
      .toArray()
