...
Collection.prototype.changes = function(pipeline, options) {
  ...
  if (serverSupportsChangeNotifications) {
    ...
    return oplogTranslator.createChangeNotificationCursor(this.s.topology, this.s.db.databaseName, this.collectionName, pipeline)
  }
}

define.classMethod('changes', {callback: true, promise:false});
