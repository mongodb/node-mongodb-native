 ...
 * @param {object|array} [fields] Indicates which fields should be included in the response (default is all).
 * @param {object} [options] Options.
 * @param {object|array} [options.fields] Indicates which fields should be included in the response (default is all).
 * @param {number} [options.skip] The number of documents to skip.
 * @param {number} [options.limit] The limit of documents.
 * @param {boolean} [options.raw] Return document as Raw Buffer.
 * @param {string} [options.hint] Current index hint for collection.
 * @param {boolean} [options.timeout] Specify if the cursor can timeout.
 * @param {boolean} [options.slaveOk] Override default configuration, allows the current connection to allow read operations to run on secondary members
 * @param {Function} [callback] Has two parameters - an error object (if an error occured) and a cursor object.
 * @throws {MongoError}
 * @return {Cursor}
 */
