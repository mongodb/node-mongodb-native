...
class Collection {
   ...
   *
   * @function
   * @param {object[]} indexSpecs An array of index specifications to be created
   * @param {object} [options] Optional settings
   * @param {ClientSession} [options.session] optional session to use for this operation
  ...
  dropIndex(indexName, options, callback) {
    ...
    // @ts-ignore TODO:(ts) better types
  ...
  distinct(key, query, options, callback) {
    ...
    const distinctOperation = /** @type {any} */ (new DistinctOperation(
      this,
      key,
      queryOption,
      optionsOption
