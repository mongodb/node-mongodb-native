...
Collection.prototype.options = function(opts, callback) {
  ...
  return executeOperation(this, options, [this, opts, callback]);
};
...
Collection.prototype.isCapped = function(options, callback) {
  ...
  return executeOperation(this, isCapped, [this, options, callback]);
};
...
Collection.prototype.createIndexes = function(indexSpecs, options, callback) {
  ...
  return executeOperation(this, createIndexes, [this, indexSpecs, options, callback]);
};
...
var createIndexes = function(self, indexSpecs, options, callback) {
  ...
  options = assign({}, { readPreference: ReadPreference.PRIMARY }, options);
...
Collection.prototype.indexExists = function(indexes, options, callback) {
  ...
  return executeOperation(this, indexExists, [this, indexes, options, callback]);
};
...
Collection.prototype.indexes = function(options, callback) {
  ...
  return executeOperation(this, indexes, [this, options, callback]);
};
...
var mapReduce = function(self, map, reduce, options, callback) {
  ...
  // Execute command
  self.s.db.command(mapCommandHash, { readPreference: options.readPreference }, function(
    err,
    result
  ) {
    if (err) return handleCallback(callback, err);
