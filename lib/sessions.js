...
/** @typedef {import('./transactions').TransactionOptions} TransactionOptions */
 ...
 * @property {any} [initialClusterTime] TODO:(neal) documentation and type
 * @property {any} [owner] TODO:(neal) documentation and type
 * @property {any} [explicit] TODO:(neal) documentation and type
...
class ClientSession extends EventEmitter {
   ...
   *
   * @type {any} TODO:(neal) better type
   */
  get id() {
   ...
   *
   * @param {Function} [callback] optional callback for completion of this operation
   * @returns {Promise} A promise is returned if no callback is provided
   */
 ...
 * @returns {MongoError|null} An error, if some error condition was met
 */
