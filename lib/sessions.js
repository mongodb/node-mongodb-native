 ...
 * @property {any} [initialClusterTime] TODO:(ts) documentation and type
 * @property {any} [owner] TODO:(ts) documentation and type
 * @property {any} [explicit] TODO:(ts) documentation and type
...
class ClientSession extends EventEmitter {
   ...
   *
   * @type {any} id TODO:(ts) better types
   */
  get id() {
