 ...
 * @property {any} [initialClusterTime] The most recent cluster time seen by this session
 * @property {any} [owner] the owner of the session
 * @property {boolean} [explicit] Is session explicit
