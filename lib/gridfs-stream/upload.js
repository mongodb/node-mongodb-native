 ...
 * @param {GridFSBucketErrorCallback} callback Function to call when the chunk was added to the buffer, or if the entire chunk was persisted to MongoDB if this chunk caused a flush.
 ...
 * @param {Buffer} chunk Buffer to write
 * @param {string} encoding Optional encoding for the buffer
 * @param {GridFSBucketErrorCallback} callback Function to call when all files and chunks have been persisted to MongoDB
 */
