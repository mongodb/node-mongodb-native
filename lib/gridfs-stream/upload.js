...
// type imports
/** @typedef {import('./index')} GridFSBucket */
/** @typedef {import('./index').GridFSBucketErrorCallback} GridFSBucketErrorCallback */
...
class GridFSBucketWriteStream extends Writable {
   ...
   *
   * @param {any} chunk Buffer to write
   * @param {any} [encoding] Optional encoding for the buffer
   * @param {any} [callback] Function to call when the chunk was added to the buffer, or if the entire chunk was persisted to MongoDB if this chunk caused a flush.
   ...
   *
   * @function
   * @param {GridFSBucketErrorCallback} callback called when chunks are successfully removed or error occurred
   ...
   * @param {any} chunk Buffer to write
   * @param {any} [encoding] Optional encoding for the buffer
   * @param {any} [callback] Function to call when all files and chunks have been persisted to MongoDB
   *
   * TODO:(ts) better types
   */
