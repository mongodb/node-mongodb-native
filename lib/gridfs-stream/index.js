...
GridFSBucket.prototype.openDownloadStreamByName = function(filename, options) {
  options = validate(
    ...
    {},
    {
      sort: options ? (options.revision >= 0 ? { uploadDate: 1 } : null) : null,
      skip: options ? (options.revision >= 0 ? options.revision : -options.revision - 1) : null
    },
    { optionsValidationLevel: this.optionsValidationLevel }
  );
