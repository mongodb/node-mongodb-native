...
const ReplSetGetStatusOperation = require('./operations/replset_get_status');
const ServerStatusOperation = require('./operations/server_status');
...
Admin.prototype.command = function(command, options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, commandOperation, callback);
};
...
Admin.prototype.buildInfo = function(options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, buildInfoOperation, callback);
};
...
Admin.prototype.serverInfo = function(options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, serverInfoOperation, callback);
};
...
Admin.prototype.serverStatus = function(options, callback) {
  ...
  const serverStatusOperation = new ServerStatusOperation(this, options);

  return executeOperationV2(this.s.db.s.topology, serverStatusOperation, callback);
};
...
Admin.prototype.ping = function(options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, pingOperation, callback);
};
...
Admin.prototype.addUser = function(username, password, options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, addUserOperation, callback);
};
...
Admin.prototype.removeUser = function(username, options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, removeUserOperation, callback);
};
...
Admin.prototype.validateCollection = function(collectionName, options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, validateCollectionOperation, callback);
};
...
Admin.prototype.listDatabases = function(options, callback) {
  ...
  return executeOperationV2(this.s.db.s.topology, listDatabasesOperation, callback);
};
...
Admin.prototype.replSetGetStatus = function(options, callback) {
  ...
  const replSetGetStatusOperation = new ReplSetGetStatusOperation(this, options);

  return executeOperationV2(this.s.db.s.topology, replSetGetStatusOperation, callback);
};
