...
/**
 * Add a addFields stage to the aggregation pipeline
 * @method
 * @param {object} document The addFields stage document.
 * @return {AggregationCursor}
 */
AggregationCursor.prototype.addFields = function(document) {
  this.s.cmd.pipeline.push({ $addFields: document });
  return this;
};
