  ...
  urlOptions.forEach(function(opt) {
    ...
    switch(name) {
      ...
      case 'readPreferenceTags':
        ...
        break;
      case 'compressors':
        var compression = serverOptions.compression || {};
      ...
      case 'zlibCompressionLevel':
        ...
        if (zlibCompressionLevel < -1 || zlibCompressionLevel > 9) throw new Error("zlibCompressionLevel must be an integer between -1 and 9");
