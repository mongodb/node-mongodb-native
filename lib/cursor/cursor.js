...
const { handleCallback, maybePromise, formattedOrderClause } = require('../utils');
const executeOperation = require('../operations/execute_operation');
const { each } = require('../operations/cursor_ops');
...
class Cursor extends CoreCursor {
   ...
   *
   * @function
   * @param {CursorResultCallback} [callback] The result callback.
   * @throws {MongoError}
   ...
   *
   * @callback CursorIteratorCallback
   ...
   *
   * @function
   * @param {CursorIteratorCallback} iterator The iteration callback.
   * @param {CursorEndCallback} callback The end callback.
   * @throws {MongoError}
   ...
   *
   * @function
   * @param {CursorToArrayResultCallback} [callback] The result callback.
   * @throws {MongoError}
   * @returns {Promise|void} returns Promise if no callback passed
   */
  toArray(callback) {
   ...
   * @param {CursorCountResultCallback} [callback] The result callback.
   ...
   * @param {CursorResultCallback} [callback] The result callback.
   * @returns {Promise | boolean} returns Promise if no callback passed
   */
 ...
 * @param {MongoError} [error] An error instance representing the error during the execution.
 * @param {(object|boolean)} [result] The result object if the command was executed successfully.
 */

/**
 * The callback format for results
 *
 * @callback CursorToArrayResultCallback
 * @param {MongoError} error An error instance representing the error during the execution.
 ...
 * The callback format for results
 *
 * @callback CursorCountResultCallback
 * @param {MongoError} [error] An error instance representing the error during the execution.
