...
class CoreCursor extends Readable {
   ...
   * @param {any} [options.raw] TODO:(ts) documentation
   * @param {boolean} [options.promoteLongs] TODO:(ts) documentation
   * @param {boolean} [options.promoteValues] TODO:(ts) documentation
   * @param {boolean} [options.promoteBuffers] TODO:(ts) documentation
   * @param {object} [options.session] TODO:(ts) documentation
   * @param {boolean} [options.noCursorTimeout] TODO:(ts) documentation
   * @param {ReadPreference} [options.readPreference] TODO:(ts) documentation
   * @param {boolean} [options.tailable] TODO:(ts) documentation
   * @param {any} [options.hint] TODO:(ts) documentation
   * @param {any} [options.startAfter] TODO:(ts) documentation
  ...
  constructor(topology, ns, cmd, options) {
    ...
    if (ns instanceof OperationBase) {
      /** @type {any} TODO:(ts) better typing */
      this.operation = ns;
  ...
  async *[Symbol.asyncIterator]() {
    ...
    while (true) {
      ...
      // @ts-ignore TODO:(ts) another Promise<void> | void error
      if (!value) {
        await this.close();
        return;
      }
