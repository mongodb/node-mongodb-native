...
function deprecateParams(fn, fName, deprecatedParams, optionsIndex, input_message = undefined) {
  const paramsWarned = {};
  function deprecated(...args) {
    const options = shallowClone(args[optionsIndex]);

    deprecatedParams.forEach(deprecatedParam => {
