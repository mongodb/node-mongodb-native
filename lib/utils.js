 ...
 * Warns only once.
 *
 * @param {object} [config] optional configuration for warning messages and/or specifying parameters to deprecate
 * @param {string} [config.fName] function name
 * @param {Array} [config.deprecatedParams] parameters to deprecate
 * @param {number} [config.optionsIndex] index of options object in function arguments array
 * @param {string} [config.msg] custom warn message to override default
