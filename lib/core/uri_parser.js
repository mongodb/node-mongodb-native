...
function parseQueryString(query, options) {
  ...
  checkTLSOptions(parsedQueryString, options);
 ...
 */
function checkTLSOptions(queryString, options) {
  ...
  // const fullOptions = Object.assign({}, options, queryString);
  // console.log({ fullOptions });

  // // I didn't expect to have lowercase versions of directconnection here, apparently tests pass caseTranslate: false
  // // which internally switches all options from the passed in directConnection to directconnection
  // if (fullOptions.ssl && (fullOptions.directconnection || fullOptions.directConnection)) {
