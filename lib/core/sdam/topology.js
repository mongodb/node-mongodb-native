...
class Topology extends EventEmitter {
  ...
  serverUpdateHandler(serverDescription) {
    ...
    // if (
    //   serverDescription.topologyVersion != null &&
    //   previousServerDescription.topologyVersion != null &&
    //   compareTopologyVersion(
    //     serverDescription.topologyVersion,
    //     previousServerDescription.topologyVersion
    //   ) < 0
    // ) {
    //   console.log('INGORING SERVER DESCRIPTION');
    //   console.dir({
    //     sd: serverDescription.topologyVersion,
    //     psd: previousServerDescription.topologyVersion,
    //     compared: compareTopologyVersion(
    //       serverDescription.topologyVersion,
    //       previousServerDescription.topologyVersion
    //     )
    //   });
