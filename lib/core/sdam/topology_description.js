...
class TopologyDescription {
  ...
  update(serverDescription) {
    ...
    // check the serverDescription.setName and the topologyDescription.setName
    // (this.setName) to see if they both match, if they don't, set
    // serverDescription to a new instance where the ismaster response is null,
    // which will set the type of the new ServerDescription to Unknown, for SPEC-1656
