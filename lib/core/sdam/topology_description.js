...
class TopologyDescription {
  ...
  update(serverDescription) {
    ...
    if (topologyType === TopologyType.Unknown) {
      if (serverType === ServerType.Standalone && this.options.directConnection !== false) {
        serverDescriptions.delete(address);
      } else {
        topologyType = topologyTypeForServerType(serverType, this.options);
      }
    }
...
function topologyTypeForServerType(serverType, options) {
  ...
  if (
    ...
    (serverType === ServerType.Unknown || serverType === ServerType.RSGhost)
  ) {
