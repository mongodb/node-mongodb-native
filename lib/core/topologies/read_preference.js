 ...
 * @param {object} [options.hedge] Enables hedged reads
 * @param {boolean} [options.hedge.enabled] Enables hedged reads
...
const ReadPreference = function(mode, tags, options) {
  ...
  // if (options.hedge && mode !== ReadPreference.nearest) {
  //   throw new TypeError('Option [hedge] is only ');
  // }
  ...
  this.mode = mode;
  this.tags = tags;
  this.hedge = (this.options && this.options.hedge) || undefined;
