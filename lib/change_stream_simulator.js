...
var createChangeStreamCursorSimulation = function (serverConfig, namespace, pipeline, options) {
  ...
  if (!serverConfig.s || !serverConfig.s.replset) {
  ...
  oplogStream.on('data', function(changeNotification) {
    ...
    lookUpDocument(serverConfig, options, changeNotification).then(function (change) {
...
var lookUpDocument = function(serverConfig, options, change) {
