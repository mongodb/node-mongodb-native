 ...
 */
var executeBatch = function(bulkOperation, batch, options, callback) {
 ...
 * @param {function} callback
 */
var executeBatches = function(bulkOperation, options, callback) {
  var numberOfCommandsToExecute = bulkOperation.s.batches.length;
