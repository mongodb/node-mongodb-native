...
function OrderedBulkOperation(topology, collection, options) {
  ...
  // Set max byte size
	var maxBatchSizeBytes = topology.isMasterDoc ? topology.isMasterDoc.maxBsonObjectSize : (1024*1025*16);
	var maxWriteBatchSize = topology.isMasterDoc ? topology.isMasterDoc.maxWriteBatchSize : 1000;
