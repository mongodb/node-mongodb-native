...
OrderedBulkOperation.prototype.insert = function(document) {
  ...
  return this.addToOperationsList(this, common.INSERT, document);
};
...
OrderedBulkOperation.prototype.raw = function(op) {
  ...
  if (
    ...
    return this.addToOperationsList(this, common.UPDATE, op[key]);
  }
  ...
  if (op.updateOne || op.updateMany || op.replaceOne) {
    ...
    return this.addToOperationsList(this, common.UPDATE, operation);
  }
  ...
  if (
    ...
    return this.addToOperationsList(this, common.REMOVE, op[key]);
  }
  ...
  if (op.deleteOne || op.deleteMany) {
    ...
    if (op.collation) operation.collation = op.collation;
    return this.addToOperationsList(this, common.REMOVE, operation);
  }

  // Insert operations
  if (op.insertOne && op.insertOne.document == null) {
    if (forceServerObjectId !== true && op.insertOne._id == null) op.insertOne._id = new ObjectID();
    return this.addToOperationsList(this, common.INSERT, op.insertOne);
  } else if (op.insertOne && op.insertOne.document) {
    if (forceServerObjectId !== true && op.insertOne.document._id == null)
      op.insertOne.document._id = new ObjectID();
    return this.addToOperationsList(this, common.INSERT, op.insertOne.document);
  }
