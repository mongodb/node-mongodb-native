...
// type imports
/** @typedef {InstanceType<import('./unordered')['UnorderedBulkOperation']>} UnorderedBulkOperation */
/** @typedef {InstanceType<import('./ordered')['OrderedBulkOperation']>} OrderedBulkOperation */
/** @typedef {import('../write_concern')} WriteConcern */
 ...
 * @param {(WriteConcernError | MongoWriteConcernError) & {result?: any}} err
...
class FindOperators {
   ...
   * @returns {OrderedBulkOperation|UnorderedBulkOperation} A reference to the parent BulkOperation
   */
...
class BulkOperationBase {
   ...
   *
   * @function
   * @param {any} op The raw operation to perform. TODO:(ts) this needs a better interface
   ...
   *
   * @callback BulkOperationBaseResultCallback
   ...
   * @param {BulkOperationBaseResultCallback} [callback] A callback that will be invoked when bulkWrite finishes/errors
  ...
  finalOptionsHandler(config, callback) {
    ...
    // Set an operationId if provided
    if (this['operationId']) {
