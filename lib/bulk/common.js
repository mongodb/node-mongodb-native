...
var BatchWriteResult = function(bulkResult) {
  ...
  defineReadOnlyProperty(this, "nInserted", bulkResult.nInserted || 0);
  defineReadOnlyProperty(this, "nUpserted", bulkResult.nUpserted || 0);
  defineReadOnlyProperty(this, "nMatched", bulkResult.nMatched || 0);
  defineReadOnlyProperty(this, "nModified", bulkResult.nModified || 0);
  defineReadOnlyProperty(this, "nRemoved", bulkResult.nRemoved || 0);
