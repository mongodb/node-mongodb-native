 ...
 * @ignore
 */
const Batch = function(batchType, originalZeroIndex) {
 ...
 * @ignore
 */
const LegacyOp = function(batchType, operation, index) {
  this.batchType = batchType;
  this.index = index;
 ...
 */
const BulkWriteResult = function(bulkResult) {
 ...
 * @ignore
 */
const mergeBatchResults = function(ordered, batch, bulkResult, err, result) {
 ...
 */
function Update(updateDocument, bulk) {
  // Perform upsert
 ...
 * @return {OrderedBulkOperation or UnordedBulkOperation}
 */
function UpdateOne(updateDocument, bulk) {
  // Perform upsert
  const upsert = typeof bulk.s.currentOp.upsert === 'boolean' ? bulk.s.currentOp.upsert : false;
 ...
 */
function Execute(_writeConcern, options, callback, bulk) {
...
/**
 * Manages final options before executing command
 * @param {object} config
 ...
 * @param {class} bulk either OrderedBulkOperation or UnorderdBulkOperation
 */
// function FinalOptionsManagement(options, batch, resultHandler, callback, bulk) {
function FinalOptionsManagement(config, bulk, callback) {
